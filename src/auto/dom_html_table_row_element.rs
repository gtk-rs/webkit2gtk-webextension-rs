    ...
    fn connect_property_cells_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            ...
            connect_raw(
                ...
                Some(transmute(notify_cells_trampoline::<Self, F> as usize)),
                Box_::into_raw(f),
            )
        }
    }
    ...
    fn connect_property_row_index_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            ...
            connect_raw(
                ...
                Some(transmute(notify_row_index_trampoline::<Self, F> as usize)),
                Box_::into_raw(f),
            )
        }
    }
    ...
    fn connect_property_section_row_index_notify<F: Fn(&Self) + 'static>(
        ...
        unsafe {
            ...
            connect_raw(
                ...
                Some(transmute(
                    notify_section_row_index_trampoline::<Self, F> as usize,
                )),
                Box_::into_raw(f),
            )
        }
