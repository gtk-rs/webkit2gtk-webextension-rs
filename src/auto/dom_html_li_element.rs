...
impl<O: IsA<DOMHTMLLIElement>> DOMHTMLLIElementExt for O {
    fn get_type_attr(&self) -> Option<GString> {
        unsafe {
            from_glib_full(
                webkit2_webextension_sys::webkit_dom_html_li_element_get_type_attr(
    ...
    fn get_value(&self) -> libc::c_long {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_li_element_get_value(
                self.as_ref().to_glib_none().0,
            )
        }
    }
    ...
    fn set_type_attr(&self, value: &str) {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_li_element_set_type_attr(
                self.as_ref().to_glib_none().0,
    ...
    fn set_value(&self, value: libc::c_long) {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_li_element_set_value(
                self.as_ref().to_glib_none().0,
                value,
            );
        }
    ...
    fn connect_property_type_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_type_trampoline<P, F: Fn(&P) + 'static>(
            this: *mut webkit2_webextension_sys::WebKitDOMHTMLLIElement,
