...
glib_wrapper! {
    pub struct UserMessage(Object<webkit2_webextension_sys::WebKitUserMessage, webkit2_webextension_sys::WebKitUserMessageClass, UserMessageClass>);

    match fn {
        get_type => || webkit2_webextension_sys::webkit_user_message_get_type(),
    }
}
...
impl UserMessage {
    ...
    pub fn new(name: &str, parameters: Option<&glib::Variant>) -> UserMessage {
        ...
        unsafe {
            from_glib_none(webkit2_webextension_sys::webkit_user_message_new(
                name.to_glib_none().0,
    ...
    pub fn with_fd_list<P: IsA<gio::UnixFDList>>(
        ...
        unsafe {
            from_glib_none(
                webkit2_webextension_sys::webkit_user_message_new_with_fd_list(
                    name.to_glib_none().0,
                    parameters.to_glib_none().0,
    ...
    pub fn error_quark() -> glib::Quark {
        assert_initialized_main_thread!();
        unsafe { from_glib(webkit2_webextension_sys::webkit_user_message_error_quark()) }
    }
}
...
impl<O: IsA<UserMessage>> UserMessageExt for O {
    ...
    fn get_fd_list(&self) -> Option<gio::UnixFDList> {
        unsafe {
            from_glib_none(webkit2_webextension_sys::webkit_user_message_get_fd_list(
    ...
    fn get_name(&self) -> Option<GString> {
        unsafe {
            from_glib_none(webkit2_webextension_sys::webkit_user_message_get_name(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn get_parameters(&self) -> Option<glib::Variant> {
        unsafe {
            from_glib_none(
                webkit2_webextension_sys::webkit_user_message_get_parameters(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn send_reply<P: IsA<UserMessage>>(&self, reply: &P) {
        unsafe {
            webkit2_webextension_sys::webkit_user_message_send_reply(
                self.as_ref().to_glib_none().0,
