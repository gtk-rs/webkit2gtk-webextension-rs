...
pub trait DOMEventExt {
    ...
    fn get_property_default_prevented(&self) -> bool;

    fn get_property_is_trusted(&self) -> bool;
...
impl<O: IsA<DOMEvent> + IsA<Object>> DOMEventExt for O {
    ...
    fn get_property_default_prevented(&self) -> bool {
        ...
        unsafe {
            gobject_ffi::g_object_get_property(self.to_glib_none().0, "default-prevented".to_glib_none().0, value.to_glib_none_mut().0);
        }
        value.get().unwrap()
    }
    ...
    fn get_property_is_trusted(&self) -> bool {
        let mut value = Value::from(&false);
        unsafe {
            gobject_ffi::g_object_get_property(self.to_glib_none().0, "is-trusted".to_glib_none().0, value.to_glib_none_mut().0);
        }
        value.get().unwrap()
    }
