...
pub trait DOMEventExt {
    ...
    //fn get_current_target(&self) -> /*Ignored*/Option<DOMEventTarget>;
    ...
    //fn get_src_element(&self) -> /*Ignored*/Option<DOMEventTarget>;

    //fn get_target(&self) -> /*Ignored*/Option<DOMEventTarget>;
