...
pub trait DOMEventExt: 'static {
    ...
    fn get_event_type(&self) -> Option<glib::GString>;
...
impl<O: IsA<DOMEvent>> DOMEventExt for O {
    ...
    fn connect_property_bubbles_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_bubbles_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMEvent, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
    ...
    fn connect_property_cancel_bubble_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_cancel_bubble_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMEvent, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMEvent>
        {
            let f: &F = &*(f as *const F);
            f(&DOMEvent::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_cancelable_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_cancelable_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMEvent, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMEvent>
        {
            let f: &F = &*(f as *const F);
            f(&DOMEvent::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_current_target_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_current_target_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMEvent, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMEvent>
        {
            let f: &F = &*(f as *const F);
            f(&DOMEvent::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_event_phase_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_event_phase_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMEvent, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMEvent>
        {
            let f: &F = &*(f as *const F);
            f(&DOMEvent::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_return_value_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_return_value_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMEvent, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMEvent>
        {
            let f: &F = &*(f as *const F);
            f(&DOMEvent::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_src_element_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_src_element_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMEvent, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMEvent>
        {
            let f: &F = &*(f as *const F);
            f(&DOMEvent::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_target_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_target_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMEvent, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMEvent>
        {
            let f: &F = &*(f as *const F);
            f(&DOMEvent::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_time_stamp_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_time_stamp_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMEvent, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMEvent>
        {
            let f: &F = &*(f as *const F);
            f(&DOMEvent::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_type_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_type_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMEvent, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMEvent>
        {
            let f: &F = &*(f as *const F);
            f(&DOMEvent::from_glib_borrow(this).unsafe_cast_ref())
