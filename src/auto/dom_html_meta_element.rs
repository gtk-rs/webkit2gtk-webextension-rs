...
impl<O: IsA<DOMHTMLMetaElement>> DOMHTMLMetaElementExt for O {
    ...
    fn connect_content_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_content_trampoline<P: IsA<DOMHTMLMetaElement>, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLMetaElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
    ...
    fn connect_http_equiv_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_http_equiv_trampoline<P: IsA<DOMHTMLMetaElement>, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLMetaElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(DOMHTMLMetaElement::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::http-equiv\0".as_ptr() as *const _,
                Some(transmute::<_, unsafe extern "C" fn()>(notify_http_equiv_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    fn connect_name_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_name_trampoline<P: IsA<DOMHTMLMetaElement>, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLMetaElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(DOMHTMLMetaElement::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_scheme_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_scheme_trampoline<P: IsA<DOMHTMLMetaElement>, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLMetaElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(DOMHTMLMetaElement::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::scheme\0".as_ptr() as *const _,
                Some(transmute::<_, unsafe extern "C" fn()>(notify_scheme_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
}
