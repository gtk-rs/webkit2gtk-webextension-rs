...
impl<O: IsA<DOMStyleSheet>> DOMStyleSheetExt for O {
    ...
    fn connect_property_disabled_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_disabled_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMStyleSheet, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
    ...
    fn connect_property_href_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_href_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMStyleSheet, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMStyleSheet>
        {
            let f: &F = &*(f as *const F);
            f(&DOMStyleSheet::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_media_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_media_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMStyleSheet, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMStyleSheet>
        {
            let f: &F = &*(f as *const F);
            f(&DOMStyleSheet::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_owner_node_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_owner_node_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMStyleSheet, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMStyleSheet>
        {
            let f: &F = &*(f as *const F);
            f(&DOMStyleSheet::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_parent_style_sheet_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_parent_style_sheet_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMStyleSheet, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMStyleSheet>
        {
            let f: &F = &*(f as *const F);
            f(&DOMStyleSheet::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_title_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_title_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMStyleSheet, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMStyleSheet>
        {
            let f: &F = &*(f as *const F);
            f(&DOMStyleSheet::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_type_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_type_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMStyleSheet, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMStyleSheet>
        {
            let f: &F = &*(f as *const F);
            f(&DOMStyleSheet::from_glib_borrow(this).unsafe_cast_ref())
