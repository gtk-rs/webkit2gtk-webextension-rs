...
impl<O: IsA<DOMStyleSheet>> DOMStyleSheetExt for O {
    fn get_content_type(&self) -> Option<GString> {
        unsafe {
            from_glib_full(
                webkit2_webextension_sys::webkit_dom_style_sheet_get_content_type(
    ...
    fn get_disabled(&self) -> bool {
        unsafe {
            from_glib(
                webkit2_webextension_sys::webkit_dom_style_sheet_get_disabled(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn get_href(&self) -> Option<GString> {
        unsafe {
            from_glib_full(webkit2_webextension_sys::webkit_dom_style_sheet_get_href(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn get_media(&self) -> Option<DOMMediaList> {
        unsafe {
            from_glib_full(webkit2_webextension_sys::webkit_dom_style_sheet_get_media(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn get_owner_node(&self) -> Option<DOMNode> {
        unsafe {
            from_glib_none(
                webkit2_webextension_sys::webkit_dom_style_sheet_get_owner_node(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn get_parent_style_sheet(&self) -> Option<DOMStyleSheet> {
        unsafe {
            from_glib_full(
                webkit2_webextension_sys::webkit_dom_style_sheet_get_parent_style_sheet(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn get_title(&self) -> Option<GString> {
        unsafe {
            from_glib_full(webkit2_webextension_sys::webkit_dom_style_sheet_get_title(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn set_disabled(&self, value: bool) {
        unsafe {
            webkit2_webextension_sys::webkit_dom_style_sheet_set_disabled(
                self.as_ref().to_glib_none().0,
                value.to_glib(),
            );
        }
    ...
    fn connect_property_disabled_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_disabled_trampoline<P, F: Fn(&P) + 'static>(
            this: *mut webkit2_webextension_sys::WebKitDOMStyleSheet,
    ...
    fn connect_property_owner_node_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            ...
            connect_raw(
                ...
                Some(transmute(notify_owner_node_trampoline::<Self, F> as usize)),
                Box_::into_raw(f),
            )
        }
    }
    ...
    fn connect_property_parent_style_sheet_notify<F: Fn(&Self) + 'static>(
        ...
        unsafe {
            ...
            connect_raw(
                ...
                Some(transmute(
                    notify_parent_style_sheet_trampoline::<Self, F> as usize,
                )),
                Box_::into_raw(f),
            )
        }
