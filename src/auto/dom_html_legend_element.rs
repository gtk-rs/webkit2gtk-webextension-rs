...
unsafe extern "C" fn notify_align_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLLegendElement, _param_spec: glib_ffi::gpointer, f: glib_ffi::gpointer)
where P: IsA<DOMHTMLLegendElement> {
    let f: &F = &*(f as *const F);
    f(&DOMHTMLLegendElement::from_glib_borrow(this).unsafe_cast())
}

unsafe extern "C" fn notify_form_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLLegendElement, _param_spec: glib_ffi::gpointer, f: glib_ffi::gpointer)
where P: IsA<DOMHTMLLegendElement> {
    let f: &F = &*(f as *const F);
    f(&DOMHTMLLegendElement::from_glib_borrow(this).unsafe_cast())
}
