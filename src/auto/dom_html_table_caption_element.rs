...
glib_wrapper! {
    pub struct DOMHTMLTableCaptionElement(Object<ffi::WebKitDOMHTMLTableCaptionElement, ffi::WebKitDOMHTMLTableCaptionElementClass>): DOMHTMLElement, DOMElement, DOMNode, DOMObject, DOMEventTarget;
