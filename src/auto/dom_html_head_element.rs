...
pub trait DOMHTMLHeadElementExt: 'static {
    ...
    fn get_profile(&self) -> Option<glib::GString>;
...
impl<O: IsA<DOMHTMLHeadElement>> DOMHTMLHeadElementExt for O {
    ...
    fn connect_property_profile_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_profile_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLHeadElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::profile\0".as_ptr() as *const _,
                Some(transmute::<_, unsafe extern "C" fn()>(notify_profile_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
}
