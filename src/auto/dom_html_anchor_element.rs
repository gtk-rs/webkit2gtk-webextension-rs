...
impl DOMHTMLAnchorElement {
    ...
    pub fn get_property_download(&self) -> Option<String> {
        let mut value = Value::from(None::<&str>);
        unsafe {
            gobject_ffi::g_object_get_property(self.to_glib_none().0, "download".to_glib_none().0, value.to_glib_none_mut().0);
        }
        value.get()
    }

    pub fn set_property_download(&self, download: Option<&str>) {
        unsafe {
            gobject_ffi::g_object_set_property(self.to_glib_none().0, "download".to_glib_none().0, Value::from(download).to_glib_none().0);
        }
    }

    pub fn get_property_origin(&self) -> Option<String> {
        let mut value = Value::from(None::<&str>);
        unsafe {
    ...
    pub fn get_property_ping(&self) -> Option<String> {
        let mut value = Value::from(None::<&str>);
        unsafe {
            gobject_ffi::g_object_get_property(self.to_glib_none().0, "ping".to_glib_none().0, value.to_glib_none_mut().0);
        }
        value.get()
    }

    pub fn set_property_ping(&self, ping: Option<&str>) {
        unsafe {
            gobject_ffi::g_object_set_property(self.to_glib_none().0, "ping".to_glib_none().0, Value::from(ping).to_glib_none().0);
        }
    }
