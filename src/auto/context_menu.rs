...
impl ContextMenu {
    pub fn new() -> ContextMenu {
        ...
        unsafe { from_glib_full(webkit2_webextension_sys::webkit_context_menu_new()) }
    }
    ...
    pub fn with_items(items: &[ContextMenuItem]) -> ContextMenu {
        ...
        unsafe {
            from_glib_full(
                webkit2_webextension_sys::webkit_context_menu_new_with_items(
...
impl<O: IsA<ContextMenu>> ContextMenuExt for O {
    fn append<P: IsA<ContextMenuItem>>(&self, item: &P) {
        unsafe {
            webkit2_webextension_sys::webkit_context_menu_append(
    ...
    fn first(&self) -> Option<ContextMenuItem> {
        unsafe {
            from_glib_none(webkit2_webextension_sys::webkit_context_menu_first(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn get_item_at_position(&self, position: u32) -> Option<ContextMenuItem> {
        unsafe {
            from_glib_none(
                webkit2_webextension_sys::webkit_context_menu_get_item_at_position(
                    self.as_ref().to_glib_none().0,
                    position,
                ),
            )
    ...
    fn get_items(&self) -> Vec<ContextMenuItem> {
        unsafe {
            FromGlibPtrContainer::from_glib_none(
                webkit2_webextension_sys::webkit_context_menu_get_items(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn get_n_items(&self) -> u32 {
        unsafe {
            webkit2_webextension_sys::webkit_context_menu_get_n_items(
                self.as_ref().to_glib_none().0,
            )
        }
    }
    ...
    fn get_user_data(&self) -> Option<glib::Variant> {
        unsafe {
            from_glib_none(webkit2_webextension_sys::webkit_context_menu_get_user_data(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn insert<P: IsA<ContextMenuItem>>(&self, item: &P, position: i32) {
        unsafe {
            webkit2_webextension_sys::webkit_context_menu_insert(
                self.as_ref().to_glib_none().0,
                item.as_ref().to_glib_none().0,
                position,
            );
    ...
    fn last(&self) -> Option<ContextMenuItem> {
        unsafe {
            from_glib_none(webkit2_webextension_sys::webkit_context_menu_last(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn move_item<P: IsA<ContextMenuItem>>(&self, item: &P, position: i32) {
        unsafe {
            webkit2_webextension_sys::webkit_context_menu_move_item(
                self.as_ref().to_glib_none().0,
                item.as_ref().to_glib_none().0,
                position,
            );
    ...
    fn prepend<P: IsA<ContextMenuItem>>(&self, item: &P) {
        unsafe {
            webkit2_webextension_sys::webkit_context_menu_prepend(
                self.as_ref().to_glib_none().0,
                item.as_ref().to_glib_none().0,
            );
        }
    ...
    fn remove<P: IsA<ContextMenuItem>>(&self, item: &P) {
        unsafe {
            webkit2_webextension_sys::webkit_context_menu_remove(
                self.as_ref().to_glib_none().0,
                item.as_ref().to_glib_none().0,
            );
        }
    ...
    fn remove_all(&self) {
        unsafe {
            webkit2_webextension_sys::webkit_context_menu_remove_all(
                self.as_ref().to_glib_none().0,
            );
        }
    }
    ...
    fn set_user_data(&self, user_data: &glib::Variant) {
        unsafe {
            webkit2_webextension_sys::webkit_context_menu_set_user_data(
                self.as_ref().to_glib_none().0,
