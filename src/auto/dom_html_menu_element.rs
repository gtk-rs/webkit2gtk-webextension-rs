...
impl<O: IsA<DOMHTMLMenuElement>> DOMHTMLMenuElementExt for O {
    ...
    fn set_compact(&self, value: bool) {
        unsafe {
            ffi::webkit_dom_html_menu_element_set_compact(self.as_ref().to_glib_none().0, value.into_glib());
        }
    }

    fn connect_compact_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_compact_trampoline<P: IsA<DOMHTMLMenuElement>, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLMenuElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
