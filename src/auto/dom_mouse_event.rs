...
pub trait DOMMouseEventExt {
    ...
    fn init_mouse_event<T: IsA<DOMEventTarget>>(&self, type_: &str, canBubble: bool, cancelable: bool, view: &DOMDOMWindow, detail: i64, screenX: i64, screenY: i64, clientX: i64, clientY: i64, ctrlKey: bool, altKey: bool, shiftKey: bool, metaKey: bool, button: u16, relatedTarget: &T);
}
