...
pub trait DOMMouseEventExt: 'static {
    ...
    #[cfg_attr(feature = "v2_22", deprecated)]
    fn init_mouse_event<P: IsA<DOMDOMWindow>, Q: IsA<DOMEventTarget>>(
        &self,
        type_: &str,
        canBubble: bool,
        cancelable: bool,
    ...
    fn connect_property_from_element_notify<F: Fn(&Self) + 'static>(&self, f: F)
        -> SignalHandlerId;
...
impl<O: IsA<DOMMouseEvent>> DOMMouseEventExt for O {
    fn get_alt_key(&self) -> bool {
        unsafe {
            from_glib(
                webkit2_webextension_sys::webkit_dom_mouse_event_get_alt_key(
    ...
    fn get_button(&self) -> libc::c_ushort {
        unsafe {
            webkit2_webextension_sys::webkit_dom_mouse_event_get_button(
                self.as_ref().to_glib_none().0,
            )
        }
    }
    ...
    fn get_client_x(&self) -> libc::c_long {
        unsafe {
            webkit2_webextension_sys::webkit_dom_mouse_event_get_client_x(
                self.as_ref().to_glib_none().0,
            )
        }
    }
    ...
    fn get_client_y(&self) -> libc::c_long {
        unsafe {
            webkit2_webextension_sys::webkit_dom_mouse_event_get_client_y(
                self.as_ref().to_glib_none().0,
            )
        }
    }
    ...
    fn get_ctrl_key(&self) -> bool {
        unsafe {
            from_glib(
                webkit2_webextension_sys::webkit_dom_mouse_event_get_ctrl_key(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn get_from_element(&self) -> Option<DOMNode> {
        unsafe {
            from_glib_none(
                webkit2_webextension_sys::webkit_dom_mouse_event_get_from_element(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn get_meta_key(&self) -> bool {
        unsafe {
            from_glib(
                webkit2_webextension_sys::webkit_dom_mouse_event_get_meta_key(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn get_offset_x(&self) -> libc::c_long {
        unsafe {
            webkit2_webextension_sys::webkit_dom_mouse_event_get_offset_x(
                self.as_ref().to_glib_none().0,
            )
        }
    }
    ...
    fn get_offset_y(&self) -> libc::c_long {
        unsafe {
            webkit2_webextension_sys::webkit_dom_mouse_event_get_offset_y(
                self.as_ref().to_glib_none().0,
            )
        }
    }
    ...
    fn get_related_target(&self) -> Option<DOMEventTarget> {
        unsafe {
            from_glib_full(
                webkit2_webextension_sys::webkit_dom_mouse_event_get_related_target(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn get_screen_x(&self) -> libc::c_long {
        unsafe {
            webkit2_webextension_sys::webkit_dom_mouse_event_get_screen_x(
                self.as_ref().to_glib_none().0,
            )
        }
    }
    ...
    fn get_screen_y(&self) -> libc::c_long {
        unsafe {
            webkit2_webextension_sys::webkit_dom_mouse_event_get_screen_y(
                self.as_ref().to_glib_none().0,
            )
        }
    }
    ...
    fn get_shift_key(&self) -> bool {
        unsafe {
            from_glib(
                webkit2_webextension_sys::webkit_dom_mouse_event_get_shift_key(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn get_to_element(&self) -> Option<DOMNode> {
        unsafe {
            from_glib_none(
                webkit2_webextension_sys::webkit_dom_mouse_event_get_to_element(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn init_mouse_event<P: IsA<DOMDOMWindow>, Q: IsA<DOMEventTarget>>(
        ...
        unsafe {
            webkit2_webextension_sys::webkit_dom_mouse_event_init_mouse_event(
                self.as_ref().to_glib_none().0,
    ...
    fn connect_property_alt_key_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_alt_key_trampoline<P, F: Fn(&P) + 'static>(
            this: *mut webkit2_webextension_sys::WebKitDOMMouseEvent,
    ...
    fn connect_property_client_x_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_client_x_trampoline<P, F: Fn(&P) + 'static>(
            this: *mut webkit2_webextension_sys::WebKitDOMMouseEvent,
            _param_spec: glib_sys::gpointer,
            f: glib_sys::gpointer,
        ) where
    ...
    fn connect_property_client_y_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_client_y_trampoline<P, F: Fn(&P) + 'static>(
            this: *mut webkit2_webextension_sys::WebKitDOMMouseEvent,
            _param_spec: glib_sys::gpointer,
            f: glib_sys::gpointer,
        ) where
    ...
    fn connect_property_ctrl_key_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_ctrl_key_trampoline<P, F: Fn(&P) + 'static>(
            this: *mut webkit2_webextension_sys::WebKitDOMMouseEvent,
            _param_spec: glib_sys::gpointer,
            f: glib_sys::gpointer,
        ) where
    ...
    fn connect_property_from_element_notify<F: Fn(&Self) + 'static>(
        ...
        unsafe extern "C" fn notify_from_element_trampoline<P, F: Fn(&P) + 'static>(
            this: *mut webkit2_webextension_sys::WebKitDOMMouseEvent,
            _param_spec: glib_sys::gpointer,
            f: glib_sys::gpointer,
        ) where
    ...
    fn connect_property_meta_key_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_meta_key_trampoline<P, F: Fn(&P) + 'static>(
            this: *mut webkit2_webextension_sys::WebKitDOMMouseEvent,
            _param_spec: glib_sys::gpointer,
            f: glib_sys::gpointer,
        ) where
    ...
    fn connect_property_offset_x_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_offset_x_trampoline<P, F: Fn(&P) + 'static>(
            this: *mut webkit2_webextension_sys::WebKitDOMMouseEvent,
            _param_spec: glib_sys::gpointer,
            f: glib_sys::gpointer,
        ) where
    ...
    fn connect_property_offset_y_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_offset_y_trampoline<P, F: Fn(&P) + 'static>(
            this: *mut webkit2_webextension_sys::WebKitDOMMouseEvent,
            _param_spec: glib_sys::gpointer,
            f: glib_sys::gpointer,
        ) where
    ...
    fn connect_property_related_target_notify<F: Fn(&Self) + 'static>(
        ...
        unsafe extern "C" fn notify_related_target_trampoline<P, F: Fn(&P) + 'static>(
            this: *mut webkit2_webextension_sys::WebKitDOMMouseEvent,
            _param_spec: glib_sys::gpointer,
            f: glib_sys::gpointer,
        ) where
    ...
    fn connect_property_shift_key_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_shift_key_trampoline<P, F: Fn(&P) + 'static>(
            this: *mut webkit2_webextension_sys::WebKitDOMMouseEvent,
            _param_spec: glib_sys::gpointer,
            f: glib_sys::gpointer,
        ) where
    ...
    fn connect_property_to_element_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_to_element_trampoline<P, F: Fn(&P) + 'static>(
            this: *mut webkit2_webextension_sys::WebKitDOMMouseEvent,
            _param_spec: glib_sys::gpointer,
            f: glib_sys::gpointer,
        ) where
