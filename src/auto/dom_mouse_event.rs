...
impl<O: IsA<DOMMouseEvent>> DOMMouseEventExt for O {
    ...
    fn connect_property_alt_key_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_alt_key_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMMouseEvent, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
    ...
    fn connect_property_button_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_button_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMMouseEvent, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMMouseEvent>
        {
            let f: &F = &*(f as *const F);
            f(&DOMMouseEvent::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_client_x_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_client_x_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMMouseEvent, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMMouseEvent>
        {
            let f: &F = &*(f as *const F);
            f(&DOMMouseEvent::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_client_y_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_client_y_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMMouseEvent, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMMouseEvent>
        {
            let f: &F = &*(f as *const F);
            f(&DOMMouseEvent::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_ctrl_key_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_ctrl_key_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMMouseEvent, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMMouseEvent>
        {
            let f: &F = &*(f as *const F);
            f(&DOMMouseEvent::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_from_element_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_from_element_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMMouseEvent, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMMouseEvent>
        {
            let f: &F = &*(f as *const F);
            f(&DOMMouseEvent::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_meta_key_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_meta_key_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMMouseEvent, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMMouseEvent>
        {
            let f: &F = &*(f as *const F);
            f(&DOMMouseEvent::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_offset_x_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_offset_x_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMMouseEvent, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMMouseEvent>
        {
            let f: &F = &*(f as *const F);
            f(&DOMMouseEvent::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_offset_y_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_offset_y_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMMouseEvent, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMMouseEvent>
        {
            let f: &F = &*(f as *const F);
            f(&DOMMouseEvent::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_related_target_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_related_target_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMMouseEvent, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMMouseEvent>
        {
            let f: &F = &*(f as *const F);
            f(&DOMMouseEvent::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_screen_x_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_screen_x_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMMouseEvent, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMMouseEvent>
        {
            let f: &F = &*(f as *const F);
            f(&DOMMouseEvent::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_screen_y_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_screen_y_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMMouseEvent, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMMouseEvent>
        {
            let f: &F = &*(f as *const F);
            f(&DOMMouseEvent::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_shift_key_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_shift_key_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMMouseEvent, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMMouseEvent>
        {
            let f: &F = &*(f as *const F);
            f(&DOMMouseEvent::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_to_element_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_to_element_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMMouseEvent, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMMouseEvent>
        {
            let f: &F = &*(f as *const F);
            f(&DOMMouseEvent::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_x_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_x_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMMouseEvent, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMMouseEvent>
        {
            let f: &F = &*(f as *const F);
            f(&DOMMouseEvent::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_y_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_y_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMMouseEvent, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMMouseEvent>
        {
            let f: &F = &*(f as *const F);
            f(&DOMMouseEvent::from_glib_borrow(this).unsafe_cast_ref())
