...
impl<O: IsA<DOMHTMLOptionsCollection>> DOMHTMLOptionsCollectionExt for O {
    ...
    fn connect_length_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_length_trampoline<P: IsA<DOMHTMLOptionsCollection>, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLOptionsCollection, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
    ...
    fn connect_selected_index_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_selected_index_trampoline<P: IsA<DOMHTMLOptionsCollection>, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLOptionsCollection, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(DOMHTMLOptionsCollection::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
