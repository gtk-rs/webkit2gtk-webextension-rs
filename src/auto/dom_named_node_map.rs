...
glib_wrapper! {
    pub struct DOMNamedNodeMap(Object<ffi::WebKitDOMNamedNodeMap, ffi::WebKitDOMNamedNodeMapClass, DOMNamedNodeMapClass>) @extends DOMObject;
...
unsafe extern "C" fn notify_length_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMNamedNodeMap, _param_spec: glib_ffi::gpointer, f: glib_ffi::gpointer)
