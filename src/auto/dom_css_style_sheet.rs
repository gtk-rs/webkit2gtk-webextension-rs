...
impl<O: IsA<DOMCSSStyleSheet>> DOMCSSStyleSheetExt for O {
    fn add_rule(
        ...
        unsafe {
            ...
            let ret = webkit2_webextension_sys::webkit_dom_css_style_sheet_add_rule(
    ...
    fn delete_rule(&self, index: libc::c_ulong) -> Result<(), glib::Error> {
        unsafe {
            let mut error = ptr::null_mut();
            let _ = webkit2_webextension_sys::webkit_dom_css_style_sheet_delete_rule(
                self.as_ref().to_glib_none().0,
                index,
                &mut error,
            );
    ...
    fn get_css_rules(&self) -> Option<DOMCSSRuleList> {
        unsafe {
            from_glib_full(
                webkit2_webextension_sys::webkit_dom_css_style_sheet_get_css_rules(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn get_owner_rule(&self) -> Option<DOMCSSRule> {
        unsafe {
            from_glib_full(
                webkit2_webextension_sys::webkit_dom_css_style_sheet_get_owner_rule(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn get_rules(&self) -> Option<DOMCSSRuleList> {
        unsafe {
            from_glib_full(
                webkit2_webextension_sys::webkit_dom_css_style_sheet_get_rules(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn insert_rule(&self, rule: &str, index: libc::c_ulong) -> Result<libc::c_ulong, glib::Error> {
        unsafe {
            let mut error = ptr::null_mut();
            let ret = webkit2_webextension_sys::webkit_dom_css_style_sheet_insert_rule(
                self.as_ref().to_glib_none().0,
                rule.to_glib_none().0,
                index,
                &mut error,
    ...
    fn remove_rule(&self, index: libc::c_ulong) -> Result<(), glib::Error> {
        unsafe {
            let mut error = ptr::null_mut();
            let _ = webkit2_webextension_sys::webkit_dom_css_style_sheet_remove_rule(
                self.as_ref().to_glib_none().0,
                index,
                &mut error,
            );
    ...
    fn connect_property_css_rules_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_css_rules_trampoline<P, F: Fn(&P) + 'static>(
            this: *mut webkit2_webextension_sys::WebKitDOMCSSStyleSheet,
