...
impl DOMHTMLIFrameElement {
    ...
    pub fn get_property_sandbox(&self) -> Option<String> {
        let mut value = Value::from(None::<&str>);
        unsafe {
            gobject_ffi::g_object_get_property(self.to_glib_none().0, "sandbox".to_glib_none().0, value.to_glib_none_mut().0);
        }
        value.get()
    }

    pub fn set_property_sandbox(&self, sandbox: Option<&str>) {
        unsafe {
            gobject_ffi::g_object_set_property(self.to_glib_none().0, "sandbox".to_glib_none().0, Value::from(sandbox).to_glib_none().0);
        }
    }

    pub fn get_property_srcdoc(&self) -> Option<String> {
        let mut value = Value::from(None::<&str>);
        unsafe {
            gobject_ffi::g_object_get_property(self.to_glib_none().0, "srcdoc".to_glib_none().0, value.to_glib_none_mut().0);
        }
        value.get()
    }

    pub fn set_property_srcdoc(&self, srcdoc: Option<&str>) {
        unsafe {
            gobject_ffi::g_object_set_property(self.to_glib_none().0, "srcdoc".to_glib_none().0, Value::from(srcdoc).to_glib_none().0);
        }
    }
}
