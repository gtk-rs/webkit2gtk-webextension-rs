...
impl<O: IsA<DOMHTMLIFrameElement>> DOMHTMLIFrameElementExt for O {
    fn get_align(&self) -> Option<GString> {
        unsafe {
            from_glib_full(
                webkit2_webextension_sys::webkit_dom_html_iframe_element_get_align(
    ...
    fn get_content_window(&self) -> Option<DOMDOMWindow> {
        unsafe {
            from_glib_full(
                webkit2_webextension_sys::webkit_dom_html_iframe_element_get_content_window(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn get_frame_border(&self) -> Option<GString> {
        unsafe {
            from_glib_full(
                webkit2_webextension_sys::webkit_dom_html_iframe_element_get_frame_border(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn get_height(&self) -> Option<GString> {
        unsafe {
            from_glib_full(
                webkit2_webextension_sys::webkit_dom_html_iframe_element_get_height(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn get_long_desc(&self) -> Option<GString> {
        unsafe {
            from_glib_full(
                webkit2_webextension_sys::webkit_dom_html_iframe_element_get_long_desc(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn get_margin_height(&self) -> Option<GString> {
        unsafe {
            from_glib_full(
                webkit2_webextension_sys::webkit_dom_html_iframe_element_get_margin_height(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn get_margin_width(&self) -> Option<GString> {
        unsafe {
            from_glib_full(
                webkit2_webextension_sys::webkit_dom_html_iframe_element_get_margin_width(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn get_name(&self) -> Option<GString> {
        unsafe {
            from_glib_full(
                webkit2_webextension_sys::webkit_dom_html_iframe_element_get_name(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn get_scrolling(&self) -> Option<GString> {
        unsafe {
            from_glib_full(
                webkit2_webextension_sys::webkit_dom_html_iframe_element_get_scrolling(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn get_src(&self) -> Option<GString> {
        unsafe {
            from_glib_full(
                webkit2_webextension_sys::webkit_dom_html_iframe_element_get_src(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn get_width(&self) -> Option<GString> {
        unsafe {
            from_glib_full(
                webkit2_webextension_sys::webkit_dom_html_iframe_element_get_width(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn set_align(&self, value: &str) {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_iframe_element_set_align(
                self.as_ref().to_glib_none().0,
    ...
    fn set_frame_border(&self, value: &str) {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_iframe_element_set_frame_border(
                self.as_ref().to_glib_none().0,
                value.to_glib_none().0,
            );
        }
    ...
    fn set_height(&self, value: &str) {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_iframe_element_set_height(
                self.as_ref().to_glib_none().0,
                value.to_glib_none().0,
            );
        }
    ...
    fn set_long_desc(&self, value: &str) {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_iframe_element_set_long_desc(
                self.as_ref().to_glib_none().0,
                value.to_glib_none().0,
            );
        }
    ...
    fn set_margin_height(&self, value: &str) {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_iframe_element_set_margin_height(
                self.as_ref().to_glib_none().0,
                value.to_glib_none().0,
            );
        }
    ...
    fn set_margin_width(&self, value: &str) {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_iframe_element_set_margin_width(
                self.as_ref().to_glib_none().0,
                value.to_glib_none().0,
            );
        }
    ...
    fn set_name(&self, value: &str) {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_iframe_element_set_name(
                self.as_ref().to_glib_none().0,
                value.to_glib_none().0,
            );
        }
    ...
    fn set_scrolling(&self, value: &str) {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_iframe_element_set_scrolling(
                self.as_ref().to_glib_none().0,
                value.to_glib_none().0,
            );
        }
    ...
    fn set_src(&self, value: &str) {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_iframe_element_set_src(
                self.as_ref().to_glib_none().0,
                value.to_glib_none().0,
            );
        }
    ...
    fn set_width(&self, value: &str) {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_iframe_element_set_width(
                self.as_ref().to_glib_none().0,
                value.to_glib_none().0,
            );
        }
    ...
    fn connect_property_align_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_align_trampoline<P, F: Fn(&P) + 'static>(
            this: *mut webkit2_webextension_sys::WebKitDOMHTMLIFrameElement,
