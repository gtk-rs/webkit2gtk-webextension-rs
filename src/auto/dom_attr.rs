...
pub trait DOMAttrExt: 'static {
    ...
    fn connect_property_owner_element_notify<F: Fn(&Self) + 'static>(
        &self,
        f: F,
    ) -> SignalHandlerId;
...
impl<O: IsA<DOMAttr>> DOMAttrExt for O {
    fn get_name(&self) -> Option<GString> {
        unsafe {
            from_glib_full(webkit2_webextension_sys::webkit_dom_attr_get_name(
    ...
    fn get_owner_element(&self) -> Option<DOMElement> {
        unsafe {
            from_glib_none(webkit2_webextension_sys::webkit_dom_attr_get_owner_element(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn get_specified(&self) -> bool {
        unsafe {
            from_glib(webkit2_webextension_sys::webkit_dom_attr_get_specified(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn get_value(&self) -> Option<GString> {
        unsafe {
            from_glib_full(webkit2_webextension_sys::webkit_dom_attr_get_value(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn set_value(&self, value: &str) -> Result<(), glib::Error> {
        unsafe {
            ...
            let _ = webkit2_webextension_sys::webkit_dom_attr_set_value(
                self.as_ref().to_glib_none().0,
    ...
    fn connect_property_local_name_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_local_name_trampoline<P, F: Fn(&P) + 'static>(
            this: *mut webkit2_webextension_sys::WebKitDOMAttr,
    ...
    fn connect_property_owner_element_notify<F: Fn(&Self) + 'static>(
        ...
        unsafe extern "C" fn notify_owner_element_trampoline<P, F: Fn(&P) + 'static>(
            this: *mut webkit2_webextension_sys::WebKitDOMAttr,
            _param_spec: glib_sys::gpointer,
            f: glib_sys::gpointer,
        ) where
        ...
        unsafe {
            ...
            connect_raw(
                ...
                Some(transmute(
                    notify_owner_element_trampoline::<Self, F> as usize,
                )),
                Box_::into_raw(f),
            )
        }
    ...
    fn connect_property_specified_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_specified_trampoline<P, F: Fn(&P) + 'static>(
            this: *mut webkit2_webextension_sys::WebKitDOMAttr,
            _param_spec: glib_sys::gpointer,
            f: glib_sys::gpointer,
        ) where
        ...
        unsafe {
            ...
            connect_raw(
                ...
                Some(transmute(notify_specified_trampoline::<Self, F> as usize)),
                Box_::into_raw(f),
            )
        }
    }
