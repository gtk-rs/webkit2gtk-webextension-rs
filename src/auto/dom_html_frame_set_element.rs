...
impl<O: IsA<DOMHTMLFrameSetElement>> DOMHTMLFrameSetElementExt for O {
    ...
    fn connect_cols_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_cols_trampoline<P: IsA<DOMHTMLFrameSetElement>, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLFrameSetElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
    ...
    fn connect_rows_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_rows_trampoline<P: IsA<DOMHTMLFrameSetElement>, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLFrameSetElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(DOMHTMLFrameSetElement::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
