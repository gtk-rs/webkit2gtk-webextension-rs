...
pub trait DOMHTMLTableElementExt: 'static {
    ...
    fn get_cell_padding(&self) -> Option<glib::GString>;

    #[cfg_attr(feature = "v2_22", deprecated)]
    #[doc(alias = "webkit_dom_html_table_element_get_cell_spacing")]
    fn get_cell_spacing(&self) -> Option<glib::GString>;
    ...
    fn get_rules(&self) -> Option<glib::GString>;

    #[cfg_attr(feature = "v2_22", deprecated)]
    #[doc(alias = "webkit_dom_html_table_element_get_summary")]
    fn get_summary(&self) -> Option<glib::GString>;
...
impl<O: IsA<DOMHTMLTableElement>> DOMHTMLTableElementExt for O {
    ...
    fn connect_property_align_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_align_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLTableElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
    ...
    fn connect_property_bg_color_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_bg_color_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLTableElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLTableElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLTableElement::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_border_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_border_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLTableElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLTableElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLTableElement::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_caption_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_caption_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLTableElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLTableElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLTableElement::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_cell_padding_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_cell_padding_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLTableElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLTableElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLTableElement::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_cell_spacing_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_cell_spacing_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLTableElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLTableElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLTableElement::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_rows_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_rows_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLTableElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLTableElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLTableElement::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_rules_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_rules_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLTableElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLTableElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLTableElement::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_summary_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_summary_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLTableElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLTableElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLTableElement::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_t_bodies_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_t_bodies_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLTableElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLTableElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLTableElement::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_t_foot_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_t_foot_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLTableElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLTableElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLTableElement::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_t_head_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_t_head_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLTableElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLTableElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLTableElement::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_width_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_width_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLTableElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLTableElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLTableElement::from_glib_borrow(this).unsafe_cast_ref())
