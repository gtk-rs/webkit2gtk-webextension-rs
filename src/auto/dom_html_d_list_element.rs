...
glib_wrapper! {
    pub struct DOMHTMLDListElement(Object<ffi::WebKitDOMHTMLDListElement, ffi::WebKitDOMHTMLDListElementClass>): DOMHTMLElement, DOMElement, DOMNode, DOMObject, DOMEventTarget;
