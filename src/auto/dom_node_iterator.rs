...
impl<O: IsA<DOMNodeIterator>> DOMNodeIteratorExt for O {
    fn detach(&self) {
        unsafe {
            webkit2_webextension_sys::webkit_dom_node_iterator_detach(
    ...
    fn get_expand_entity_references(&self) -> bool {
        unsafe {
            from_glib(
                webkit2_webextension_sys::webkit_dom_node_iterator_get_expand_entity_references(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn get_reference_node(&self) -> Option<DOMNode> {
        unsafe {
            from_glib_none(
                webkit2_webextension_sys::webkit_dom_node_iterator_get_reference_node(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn get_root(&self) -> Option<DOMNode> {
        unsafe {
            from_glib_none(webkit2_webextension_sys::webkit_dom_node_iterator_get_root(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn get_what_to_show(&self) -> libc::c_ulong {
        unsafe {
            webkit2_webextension_sys::webkit_dom_node_iterator_get_what_to_show(
                self.as_ref().to_glib_none().0,
            )
        }
    }
    ...
    fn next_node(&self) -> Result<DOMNode, glib::Error> {
        unsafe {
            ...
            let ret = webkit2_webextension_sys::webkit_dom_node_iterator_next_node(
                self.as_ref().to_glib_none().0,
                &mut error,
            );
            if error.is_null() {
    ...
    fn previous_node(&self) -> Result<DOMNode, glib::Error> {
        unsafe {
            let mut error = ptr::null_mut();
            let ret = webkit2_webextension_sys::webkit_dom_node_iterator_previous_node(
                self.as_ref().to_glib_none().0,
                &mut error,
            );
            if error.is_null() {
    ...
    fn connect_property_filter_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_filter_trampoline<P, F: Fn(&P) + 'static>(
            this: *mut webkit2_webextension_sys::WebKitDOMNodeIterator,
    ...
    fn connect_property_reference_node_notify<F: Fn(&Self) + 'static>(
        ...
        unsafe extern "C" fn notify_reference_node_trampoline<P, F: Fn(&P) + 'static>(
            this: *mut webkit2_webextension_sys::WebKitDOMNodeIterator,
            _param_spec: glib_sys::gpointer,
            f: glib_sys::gpointer,
        ) where
