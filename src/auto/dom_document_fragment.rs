...
impl<O: IsA<DOMDocumentFragment>> DOMDocumentFragmentExt for O {
    ...
    fn connect_property_child_element_count_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_child_element_count_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMDocumentFragment, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
    ...
    fn connect_property_children_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_children_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMDocumentFragment, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMDocumentFragment>
        {
            let f: &F = &*(f as *const F);
            f(&DOMDocumentFragment::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_first_element_child_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_first_element_child_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMDocumentFragment, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMDocumentFragment>
        {
            let f: &F = &*(f as *const F);
            f(&DOMDocumentFragment::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_last_element_child_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_last_element_child_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMDocumentFragment, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMDocumentFragment>
        {
            let f: &F = &*(f as *const F);
            f(&DOMDocumentFragment::from_glib_borrow(this).unsafe_cast_ref())
