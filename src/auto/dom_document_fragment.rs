...
impl<O: IsA<DOMDocumentFragment>> DOMDocumentFragmentExt for O {
    ...
    fn get_child_element_count(&self) -> libc::c_ulong {
        unsafe {
            webkit2_webextension_sys::webkit_dom_document_fragment_get_child_element_count(
    ...
    fn get_children(&self) -> Option<DOMHTMLCollection> {
        unsafe {
            from_glib_full(
                webkit2_webextension_sys::webkit_dom_document_fragment_get_children(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn get_element_by_id(&self, elementId: &str) -> Option<DOMElement> {
        unsafe {
            from_glib_none(
                webkit2_webextension_sys::webkit_dom_document_fragment_get_element_by_id(
                    self.as_ref().to_glib_none().0,
    ...
    fn get_first_element_child(&self) -> Option<DOMElement> {
        unsafe {
            from_glib_none(
                webkit2_webextension_sys::webkit_dom_document_fragment_get_first_element_child(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn get_last_element_child(&self) -> Option<DOMElement> {
        unsafe {
            from_glib_none(
                webkit2_webextension_sys::webkit_dom_document_fragment_get_last_element_child(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn query_selector(&self, selectors: &str) -> Result<DOMElement, glib::Error> {
        unsafe {
            ...
            let ret = webkit2_webextension_sys::webkit_dom_document_fragment_query_selector(
                self.as_ref().to_glib_none().0,
    ...
    fn query_selector_all(&self, selectors: &str) -> Result<DOMNodeList, glib::Error> {
        unsafe {
            let mut error = ptr::null_mut();
            let ret = webkit2_webextension_sys::webkit_dom_document_fragment_query_selector_all(
                self.as_ref().to_glib_none().0,
                selectors.to_glib_none().0,
                &mut error,
            );
    ...
    fn connect_property_child_element_count_notify<F: Fn(&Self) + 'static>(
        ...
        unsafe extern "C" fn notify_child_element_count_trampoline<P, F: Fn(&P) + 'static>(
            this: *mut webkit2_webextension_sys::WebKitDOMDocumentFragment,
