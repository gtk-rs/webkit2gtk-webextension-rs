...
impl DOMDocumentFragment {
    #[cfg(feature = "v2_16")]
    pub fn get_child_element_count(&self) -> libc::c_ulong {
        unsafe {
    ...
    #[cfg(feature = "v2_16")]
    pub fn get_children(&self) -> Option<DOMHTMLCollection> {
        unsafe {
    ...
    #[cfg(feature = "v2_16")]
    pub fn query_selector(&self, selectors: &str) -> Result<DOMElement, Error> {
        unsafe {
    ...
    #[cfg(feature = "v2_16")]
    pub fn query_selector_all(&self, selectors: &str) -> Result<DOMNodeList, Error> {
        unsafe {
            let mut error = ptr::null_mut();
