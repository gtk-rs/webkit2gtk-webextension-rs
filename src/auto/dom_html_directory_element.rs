...
glib_wrapper! {
    pub struct DOMHTMLDirectoryElement(Object<ffi::WebKitDOMHTMLDirectoryElement, ffi::WebKitDOMHTMLDirectoryElementClass, DOMHTMLDirectoryElementClass>) @extends DOMHTMLElement, DOMElement, DOMNode, DOMObject, @implements DOMEventTarget;
...
impl<O: IsA<DOMHTMLDirectoryElement>> DOMHTMLDirectoryElementExt for O {
    ...
    fn set_compact(&self, value: bool) {
        unsafe {
            ffi::webkit_dom_html_directory_element_set_compact(self.as_ref().to_glib_none().0, value.to_glib());
        }
    }
...
unsafe extern "C" fn notify_compact_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLDirectoryElement, _param_spec: glib_ffi::gpointer, f: glib_ffi::gpointer)
