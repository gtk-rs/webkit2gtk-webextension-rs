...
impl<O: IsA<DOMHTMLDirectoryElement>> DOMHTMLDirectoryElementExt for O {
    ...
    fn connect_property_compact_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_compact_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLDirectoryElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
