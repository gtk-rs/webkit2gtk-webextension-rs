...
impl<O: IsA<DOMHTMLFrameElement>> DOMHTMLFrameElementExt for O {
    ...
    fn get_content_window(&self) -> Option<DOMDOMWindow> {
        unsafe {
            from_glib_full(
                webkit2_webextension_sys::webkit_dom_html_frame_element_get_content_window(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn get_frame_border(&self) -> Option<GString> {
        unsafe {
            from_glib_full(
                webkit2_webextension_sys::webkit_dom_html_frame_element_get_frame_border(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn get_height(&self) -> libc::c_long {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_frame_element_get_height(
                self.as_ref().to_glib_none().0,
            )
        }
    }
    ...
    fn get_long_desc(&self) -> Option<GString> {
        unsafe {
            from_glib_full(
                webkit2_webextension_sys::webkit_dom_html_frame_element_get_long_desc(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn get_margin_height(&self) -> Option<GString> {
        unsafe {
            from_glib_full(
                webkit2_webextension_sys::webkit_dom_html_frame_element_get_margin_height(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn get_margin_width(&self) -> Option<GString> {
        unsafe {
            from_glib_full(
                webkit2_webextension_sys::webkit_dom_html_frame_element_get_margin_width(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn get_name(&self) -> Option<GString> {
        unsafe {
            from_glib_full(
                webkit2_webextension_sys::webkit_dom_html_frame_element_get_name(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn get_no_resize(&self) -> bool {
        unsafe {
            from_glib(
                webkit2_webextension_sys::webkit_dom_html_frame_element_get_no_resize(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn get_scrolling(&self) -> Option<GString> {
        unsafe {
            from_glib_full(
                webkit2_webextension_sys::webkit_dom_html_frame_element_get_scrolling(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn get_src(&self) -> Option<GString> {
        unsafe {
            from_glib_full(
                webkit2_webextension_sys::webkit_dom_html_frame_element_get_src(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn get_width(&self) -> libc::c_long {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_frame_element_get_width(
                self.as_ref().to_glib_none().0,
            )
        }
    }
    ...
    fn set_frame_border(&self, value: &str) {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_frame_element_set_frame_border(
                self.as_ref().to_glib_none().0,
    ...
    fn set_long_desc(&self, value: &str) {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_frame_element_set_long_desc(
                self.as_ref().to_glib_none().0,
                value.to_glib_none().0,
            );
        }
    ...
    fn set_margin_height(&self, value: &str) {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_frame_element_set_margin_height(
                self.as_ref().to_glib_none().0,
                value.to_glib_none().0,
            );
        }
    ...
    fn set_margin_width(&self, value: &str) {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_frame_element_set_margin_width(
                self.as_ref().to_glib_none().0,
                value.to_glib_none().0,
            );
        }
    ...
    fn set_name(&self, value: &str) {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_frame_element_set_name(
                self.as_ref().to_glib_none().0,
                value.to_glib_none().0,
            );
        }
    ...
    fn set_no_resize(&self, value: bool) {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_frame_element_set_no_resize(
                self.as_ref().to_glib_none().0,
                value.to_glib(),
            );
        }
    ...
    fn set_scrolling(&self, value: &str) {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_frame_element_set_scrolling(
                self.as_ref().to_glib_none().0,
                value.to_glib_none().0,
            );
        }
    ...
    fn set_src(&self, value: &str) {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_frame_element_set_src(
                self.as_ref().to_glib_none().0,
                value.to_glib_none().0,
            );
        }
    ...
    fn connect_property_content_document_notify<F: Fn(&Self) + 'static>(
        ...
        unsafe extern "C" fn notify_content_document_trampoline<P, F: Fn(&P) + 'static>(
            this: *mut webkit2_webextension_sys::WebKitDOMHTMLFrameElement,
    ...
    fn connect_property_no_resize_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_no_resize_trampoline<P, F: Fn(&P) + 'static>(
            this: *mut webkit2_webextension_sys::WebKitDOMHTMLFrameElement,
            _param_spec: glib_sys::gpointer,
            f: glib_sys::gpointer,
        ) where
