...
glib_wrapper! {
    pub struct DOMHTMLFrameElement(Object<ffi::WebKitDOMHTMLFrameElement, ffi::WebKitDOMHTMLFrameElementClass>): DOMHTMLElement, DOMElement, DOMNode, DOMObject, DOMEventTarget;
...
where P: IsA<DOMHTMLFrameElement> {
    ...
    f(&DOMHTMLFrameElement::from_glib_borrow(this).downcast_unchecked())
}
