...
impl<O: IsA<DOMHTMLFrameElement>> DOMHTMLFrameElementExt for O {
    ...
    fn connect_property_content_document_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_content_document_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLFrameElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
    ...
    fn connect_property_content_window_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_content_window_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLFrameElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLFrameElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLFrameElement::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_frame_border_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_frame_border_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLFrameElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLFrameElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLFrameElement::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_height_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_height_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLFrameElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLFrameElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLFrameElement::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_long_desc_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_long_desc_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLFrameElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLFrameElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLFrameElement::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_margin_height_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_margin_height_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLFrameElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLFrameElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLFrameElement::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_margin_width_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_margin_width_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLFrameElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLFrameElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLFrameElement::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_name_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_name_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLFrameElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLFrameElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLFrameElement::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_no_resize_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_no_resize_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLFrameElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLFrameElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLFrameElement::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_scrolling_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_scrolling_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLFrameElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLFrameElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLFrameElement::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_src_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_src_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLFrameElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLFrameElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLFrameElement::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_width_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_width_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLFrameElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLFrameElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLFrameElement::from_glib_borrow(this).unsafe_cast_ref())
