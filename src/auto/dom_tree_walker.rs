...
impl<O: IsA<DOMTreeWalker>> DOMTreeWalkerExt for O {
    ...
    fn connect_property_current_node_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_current_node_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMTreeWalker, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
    ...
    fn connect_property_filter_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_filter_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMTreeWalker, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMTreeWalker>
        {
            let f: &F = &*(f as *const F);
            f(&DOMTreeWalker::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_root_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_root_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMTreeWalker, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMTreeWalker>
        {
            let f: &F = &*(f as *const F);
            f(&DOMTreeWalker::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_what_to_show_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_what_to_show_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMTreeWalker, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMTreeWalker>
        {
            let f: &F = &*(f as *const F);
            f(&DOMTreeWalker::from_glib_borrow(this).unsafe_cast_ref())
