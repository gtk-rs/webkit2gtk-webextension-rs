...
glib_wrapper! {
    pub struct DOMTreeWalker(Object<ffi::WebKitDOMTreeWalker, ffi::WebKitDOMTreeWalkerClass, DOMTreeWalkerClass>) @extends DOMObject;
...
unsafe extern "C" fn notify_current_node_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMTreeWalker, _param_spec: glib_ffi::gpointer, f: glib_ffi::gpointer)
where P: IsA<DOMTreeWalker> {
    let f: &F = &*(f as *const F);
    f(&DOMTreeWalker::from_glib_borrow(this).unsafe_cast())
}

unsafe extern "C" fn notify_filter_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMTreeWalker, _param_spec: glib_ffi::gpointer, f: glib_ffi::gpointer)
where P: IsA<DOMTreeWalker> {
    let f: &F = &*(f as *const F);
    f(&DOMTreeWalker::from_glib_borrow(this).unsafe_cast())
}

unsafe extern "C" fn notify_root_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMTreeWalker, _param_spec: glib_ffi::gpointer, f: glib_ffi::gpointer)
where P: IsA<DOMTreeWalker> {
    let f: &F = &*(f as *const F);
    f(&DOMTreeWalker::from_glib_borrow(this).unsafe_cast())
}

unsafe extern "C" fn notify_what_to_show_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMTreeWalker, _param_spec: glib_ffi::gpointer, f: glib_ffi::gpointer)
where P: IsA<DOMTreeWalker> {
    let f: &F = &*(f as *const F);
    f(&DOMTreeWalker::from_glib_borrow(this).unsafe_cast())
}
