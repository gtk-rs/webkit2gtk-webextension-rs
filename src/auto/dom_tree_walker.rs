...
impl<O: IsA<DOMTreeWalker>> DOMTreeWalkerExt for O {
    ...
    fn get_current_node(&self) -> Option<DOMNode> {
        unsafe {
            from_glib_none(
                webkit2_webextension_sys::webkit_dom_tree_walker_get_current_node(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn get_expand_entity_references(&self) -> bool {
        unsafe {
            from_glib(
                webkit2_webextension_sys::webkit_dom_tree_walker_get_expand_entity_references(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn get_filter(&self) -> Option<DOMNodeFilter> {
        unsafe {
            from_glib_full(webkit2_webextension_sys::webkit_dom_tree_walker_get_filter(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn get_root(&self) -> Option<DOMNode> {
        unsafe {
            from_glib_none(webkit2_webextension_sys::webkit_dom_tree_walker_get_root(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn get_what_to_show(&self) -> libc::c_ulong {
        unsafe {
            webkit2_webextension_sys::webkit_dom_tree_walker_get_what_to_show(
                self.as_ref().to_glib_none().0,
            )
        }
    }
    ...
    fn last_child(&self) -> Option<DOMNode> {
        unsafe {
            from_glib_none(webkit2_webextension_sys::webkit_dom_tree_walker_last_child(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn next_node(&self) -> Option<DOMNode> {
        unsafe {
            from_glib_none(webkit2_webextension_sys::webkit_dom_tree_walker_next_node(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn previous_node(&self) -> Option<DOMNode> {
        unsafe {
            from_glib_none(
                webkit2_webextension_sys::webkit_dom_tree_walker_previous_node(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn previous_sibling(&self) -> Option<DOMNode> {
        unsafe {
            from_glib_none(
                webkit2_webextension_sys::webkit_dom_tree_walker_previous_sibling(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn set_current_node<P: IsA<DOMNode>>(&self, value: &P) -> Result<(), glib::Error> {
        unsafe {
            ...
            let _ = webkit2_webextension_sys::webkit_dom_tree_walker_set_current_node(
                self.as_ref().to_glib_none().0,
    ...
    fn connect_property_current_node_notify<F: Fn(&Self) + 'static>(
        ...
        unsafe extern "C" fn notify_current_node_trampoline<P, F: Fn(&P) + 'static>(
            this: *mut webkit2_webextension_sys::WebKitDOMTreeWalker,
