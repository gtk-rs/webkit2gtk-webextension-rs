...
impl<O: IsA<DOMNode>> DOMNodeExt for O {
    fn append_child<P: IsA<DOMNode>>(&self, newChild: &P) -> Result<DOMNode, glib::Error> {
        unsafe {
            ...
            let ret = webkit2_webextension_sys::webkit_dom_node_append_child(
    ...
    fn clone_node(&self, deep: bool) -> Result<DOMNode, glib::Error> {
        unsafe {
            let mut error = ptr::null_mut();
            let ret = webkit2_webextension_sys::webkit_dom_node_clone_node(
                self.as_ref().to_glib_none().0,
                deep.to_glib(),
                &mut error,
            );
    ...
    fn clone_node_with_error(&self, deep: bool) -> Result<DOMNode, glib::Error> {
        unsafe {
            let mut error = ptr::null_mut();
            let ret = webkit2_webextension_sys::webkit_dom_node_clone_node_with_error(
                self.as_ref().to_glib_none().0,
                deep.to_glib(),
                &mut error,
            );
    ...
    fn compare_document_position<P: IsA<DOMNode>>(&self, other: &P) -> libc::c_ushort {
        unsafe {
            webkit2_webextension_sys::webkit_dom_node_compare_document_position(
                self.as_ref().to_glib_none().0,
    ...
    fn contains<P: IsA<DOMNode>>(&self, other: &P) -> bool {
        unsafe {
            from_glib(webkit2_webextension_sys::webkit_dom_node_contains(
                self.as_ref().to_glib_none().0,
                other.as_ref().to_glib_none().0,
            ))
        }
    ...
    fn get_base_uri(&self) -> Option<GString> {
        unsafe {
            from_glib_full(webkit2_webextension_sys::webkit_dom_node_get_base_uri(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn get_child_nodes(&self) -> Option<DOMNodeList> {
        unsafe {
            from_glib_full(webkit2_webextension_sys::webkit_dom_node_get_child_nodes(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn get_first_child(&self) -> Option<DOMNode> {
        unsafe {
            from_glib_none(webkit2_webextension_sys::webkit_dom_node_get_first_child(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn get_last_child(&self) -> Option<DOMNode> {
        unsafe {
            from_glib_none(webkit2_webextension_sys::webkit_dom_node_get_last_child(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn get_local_name(&self) -> Option<GString> {
        unsafe {
            from_glib_full(webkit2_webextension_sys::webkit_dom_node_get_local_name(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn get_namespace_uri(&self) -> Option<GString> {
        unsafe {
            from_glib_full(webkit2_webextension_sys::webkit_dom_node_get_namespace_uri(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn get_next_sibling(&self) -> Option<DOMNode> {
        unsafe {
            from_glib_none(webkit2_webextension_sys::webkit_dom_node_get_next_sibling(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn get_node_name(&self) -> Option<GString> {
        unsafe {
            from_glib_full(webkit2_webextension_sys::webkit_dom_node_get_node_name(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn get_node_value(&self) -> Option<GString> {
        unsafe {
            from_glib_full(webkit2_webextension_sys::webkit_dom_node_get_node_value(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn get_owner_document(&self) -> Option<DOMDocument> {
        unsafe {
            from_glib_none(
                webkit2_webextension_sys::webkit_dom_node_get_owner_document(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn get_parent_element(&self) -> Option<DOMElement> {
        unsafe {
            from_glib_none(
                webkit2_webextension_sys::webkit_dom_node_get_parent_element(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn get_parent_node(&self) -> Option<DOMNode> {
        unsafe {
            from_glib_none(webkit2_webextension_sys::webkit_dom_node_get_parent_node(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn get_prefix(&self) -> Option<GString> {
        unsafe {
            from_glib_full(webkit2_webextension_sys::webkit_dom_node_get_prefix(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn get_previous_sibling(&self) -> Option<DOMNode> {
        unsafe {
            from_glib_none(
                webkit2_webextension_sys::webkit_dom_node_get_previous_sibling(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn get_text_content(&self) -> Option<GString> {
        unsafe {
            from_glib_full(webkit2_webextension_sys::webkit_dom_node_get_text_content(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn has_child_nodes(&self) -> bool {
        unsafe {
            from_glib(webkit2_webextension_sys::webkit_dom_node_has_child_nodes(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn insert_before<P: IsA<DOMNode>, Q: IsA<DOMNode>>(
        ...
        unsafe {
            let mut error = ptr::null_mut();
            let ret = webkit2_webextension_sys::webkit_dom_node_insert_before(
                self.as_ref().to_glib_none().0,
                newChild.as_ref().to_glib_none().0,
    ...
    fn is_default_namespace(&self, namespaceURI: &str) -> bool {
        unsafe {
            from_glib(
                webkit2_webextension_sys::webkit_dom_node_is_default_namespace(
                    self.as_ref().to_glib_none().0,
    ...
    fn is_equal_node<P: IsA<DOMNode>>(&self, other: &P) -> bool {
        unsafe {
            from_glib(webkit2_webextension_sys::webkit_dom_node_is_equal_node(
                self.as_ref().to_glib_none().0,
                other.as_ref().to_glib_none().0,
            ))
        }
    ...
    fn is_same_node<P: IsA<DOMNode>>(&self, other: &P) -> bool {
        unsafe {
            from_glib(webkit2_webextension_sys::webkit_dom_node_is_same_node(
                self.as_ref().to_glib_none().0,
                other.as_ref().to_glib_none().0,
            ))
        }
    ...
    fn is_supported(&self, feature: &str, version: &str) -> bool {
        unsafe {
            from_glib(webkit2_webextension_sys::webkit_dom_node_is_supported(
                self.as_ref().to_glib_none().0,
    ...
    fn lookup_namespace_uri(&self, prefix: &str) -> Option<GString> {
        unsafe {
            from_glib_full(
                webkit2_webextension_sys::webkit_dom_node_lookup_namespace_uri(
                    self.as_ref().to_glib_none().0,
    ...
    fn lookup_prefix(&self, namespaceURI: &str) -> Option<GString> {
        unsafe {
            from_glib_full(webkit2_webextension_sys::webkit_dom_node_lookup_prefix(
                self.as_ref().to_glib_none().0,
                namespaceURI.to_glib_none().0,
            ))
        }
    ...
    fn remove_child<P: IsA<DOMNode>>(&self, oldChild: &P) -> Result<DOMNode, glib::Error> {
        unsafe {
            let mut error = ptr::null_mut();
            let ret = webkit2_webextension_sys::webkit_dom_node_remove_child(
                self.as_ref().to_glib_none().0,
    ...
    fn replace_child<P: IsA<DOMNode>, Q: IsA<DOMNode>>(
        ...
        unsafe {
            let mut error = ptr::null_mut();
            let ret = webkit2_webextension_sys::webkit_dom_node_replace_child(
                self.as_ref().to_glib_none().0,
                newChild.as_ref().to_glib_none().0,
                oldChild.as_ref().to_glib_none().0,
                &mut error,
    ...
    fn set_node_value(&self, value: &str) -> Result<(), glib::Error> {
        unsafe {
            let mut error = ptr::null_mut();
            let _ = webkit2_webextension_sys::webkit_dom_node_set_node_value(
                self.as_ref().to_glib_none().0,
    ...
    fn set_prefix(&self, value: &str) -> Result<(), glib::Error> {
        unsafe {
            let mut error = ptr::null_mut();
            let _ = webkit2_webextension_sys::webkit_dom_node_set_prefix(
                self.as_ref().to_glib_none().0,
                value.to_glib_none().0,
                &mut error,
            );
    ...
    fn set_text_content(&self, value: &str) -> Result<(), glib::Error> {
        unsafe {
            let mut error = ptr::null_mut();
            let _ = webkit2_webextension_sys::webkit_dom_node_set_text_content(
                self.as_ref().to_glib_none().0,
                value.to_glib_none().0,
                &mut error,
            );
    ...
    fn connect_property_base_uri_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_base_uri_trampoline<P, F: Fn(&P) + 'static>(
            this: *mut webkit2_webextension_sys::WebKitDOMNode,
