...
impl<O: IsA<DOMDOMTokenList>> DOMDOMTokenListExt for O {
    ...
    fn contains(&self, token: &str) -> bool {
        unsafe {
            from_glib(
                webkit2_webextension_sys::webkit_dom_dom_token_list_contains(
    ...
    fn get_length(&self) -> libc::c_ulong {
        unsafe {
            webkit2_webextension_sys::webkit_dom_dom_token_list_get_length(
                self.as_ref().to_glib_none().0,
            )
        }
    }
    ...
    fn get_value(&self) -> Option<GString> {
        unsafe {
            from_glib_full(
                webkit2_webextension_sys::webkit_dom_dom_token_list_get_value(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn item(&self, index: libc::c_ulong) -> Option<GString> {
        unsafe {
            from_glib_full(webkit2_webextension_sys::webkit_dom_dom_token_list_item(
                self.as_ref().to_glib_none().0,
                index,
            ))
        }
    ...
    fn replace(&self, token: &str, newToken: &str) -> Result<(), glib::Error> {
        unsafe {
            ...
            let _ = webkit2_webextension_sys::webkit_dom_dom_token_list_replace(
                self.as_ref().to_glib_none().0,
                token.to_glib_none().0,
    ...
    fn set_value(&self, value: &str) {
        unsafe {
            webkit2_webextension_sys::webkit_dom_dom_token_list_set_value(
                self.as_ref().to_glib_none().0,
    ...
    fn toggle(&self, token: &str, force: bool) -> Result<(), glib::Error> {
        unsafe {
            let mut error = ptr::null_mut();
            let _ = webkit2_webextension_sys::webkit_dom_dom_token_list_toggle(
                self.as_ref().to_glib_none().0,
                token.to_glib_none().0,
                force.to_glib(),
                &mut error,
    ...
    fn connect_property_length_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_length_trampoline<P, F: Fn(&P) + 'static>(
            this: *mut webkit2_webextension_sys::WebKitDOMDOMTokenList,
