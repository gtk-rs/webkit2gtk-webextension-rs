...
impl<O: IsA<DOMDOMTokenList>> DOMDOMTokenListExt for O {
    ...
    fn get_property_value(&self) -> Option<glib::GString> {
        unsafe {
            ...
            glib::gobject_ffi::g_object_get_property(self.to_glib_none().0 as *mut glib::gobject_ffi::GObject, b"value\0".as_ptr() as *const _, value.to_glib_none_mut().0);
    ...
    fn set_property_value(&self, value: Option<&str>) {
        unsafe {
            glib::gobject_ffi::g_object_set_property(self.to_glib_none().0 as *mut glib::gobject_ffi::GObject, b"value\0".as_ptr() as *const _, glib::Value::from(value).to_glib_none().0);
        }
    }

    fn connect_property_length_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_length_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMDOMTokenList, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
    ...
    fn connect_property_value_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_value_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMDOMTokenList, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMDOMTokenList>
        {
            let f: &F = &*(f as *const F);
            f(&DOMDOMTokenList::from_glib_borrow(this).unsafe_cast_ref())
