...
impl DOMDOMWindow {
    ...
    #[cfg(feature = "v2_16")]
    pub fn find(&self, string: &str, caseSensitive: bool, backwards: bool, wrap: bool, wholeWord: bool, searchInFrames: bool, showDialog: bool) -> bool {
        unsafe {
    ...
    #[cfg(feature = "v2_16")]
    pub fn get_computed_style<'a, P: IsA<DOMElement>, Q: Into<Option<&'a str>>>(&self, element: &P, pseudoElement: Q) -> Option<DOMCSSStyleDeclaration> {
    ...
    #[cfg(feature = "v2_16")]
    pub fn get_default_status(&self) -> Option<String> {
        unsafe {
    ...
    #[cfg(feature = "v2_16")]
    pub fn get_document(&self) -> Option<DOMDocument> {
        unsafe {
    ...
    #[cfg(feature = "v2_16")]
    pub fn get_frame_element(&self) -> Option<DOMElement> {
        unsafe {
    ...
    #[cfg(feature = "v2_16")]
    pub fn get_frames(&self) -> Option<DOMDOMWindow> {
        unsafe {
    ...
    #[cfg(feature = "v2_16")]
    pub fn get_inner_height(&self) -> libc::c_long {
        unsafe {
    ...
    #[cfg(feature = "v2_16")]
    pub fn get_inner_width(&self) -> libc::c_long {
        unsafe {
    ...
    #[cfg(feature = "v2_16")]
    pub fn get_offscreen_buffering(&self) -> bool {
        unsafe {
    ...
    #[cfg(feature = "v2_16")]
    pub fn get_opener(&self) -> Option<DOMDOMWindow> {
        unsafe {
    ...
    #[cfg(feature = "v2_16")]
    pub fn get_orientation(&self) -> libc::c_long {
        unsafe {
    ...
    #[cfg(feature = "v2_16")]
    pub fn get_outer_height(&self) -> libc::c_long {
        unsafe {
    ...
    #[cfg(feature = "v2_16")]
    pub fn get_outer_width(&self) -> libc::c_long {
        unsafe {
    ...
    #[cfg(feature = "v2_16")]
    pub fn get_page_x_offset(&self) -> libc::c_long {
        unsafe {
    ...
    #[cfg(feature = "v2_16")]
    pub fn get_page_y_offset(&self) -> libc::c_long {
        unsafe {
    ...
    #[cfg(feature = "v2_16")]
    pub fn get_parent(&self) -> Option<DOMDOMWindow> {
        unsafe {
    ...
    #[cfg(feature = "v2_16")]
    pub fn get_screen_left(&self) -> libc::c_long {
        unsafe {
    ...
    #[cfg(feature = "v2_16")]
    pub fn get_screen_top(&self) -> libc::c_long {
        unsafe {
    ...
    #[cfg(feature = "v2_16")]
    pub fn get_screen_x(&self) -> libc::c_long {
        unsafe {
    ...
    #[cfg(feature = "v2_16")]
    pub fn get_screen_y(&self) -> libc::c_long {
        unsafe {
    ...
    #[cfg(feature = "v2_16")]
    pub fn get_scroll_x(&self) -> libc::c_long {
        unsafe {
    ...
    #[cfg(feature = "v2_16")]
    pub fn get_scroll_y(&self) -> libc::c_long {
        unsafe {
    ...
    #[cfg(feature = "v2_16")]
    pub fn get_selection(&self) -> Option<DOMDOMSelection> {
        unsafe {
    ...
    #[cfg(feature = "v2_16")]
    pub fn get_self(&self) -> Option<DOMDOMWindow> {
        unsafe {
    ...
    #[cfg(feature = "v2_16")]
    pub fn get_top(&self) -> Option<DOMDOMWindow> {
        unsafe {
    ...
    #[cfg(feature = "v2_16")]
    pub fn get_window(&self) -> Option<DOMDOMWindow> {
        unsafe {
    ...
    #[cfg(feature = "v2_16")]
    pub fn prompt(&self, message: &str, defaultValue: &str) -> Option<String> {
        unsafe {
    ...
    #[cfg(feature = "v2_16")]
    pub fn resize_by(&self, x: f32, y: f32) {
        unsafe {
    ...
    #[cfg(feature = "v2_16")]
    pub fn resize_to(&self, width: f32, height: f32) {
        unsafe {
    ...
    #[cfg(feature = "v2_16")]
    pub fn set_default_status(&self, value: &str) {
        unsafe {
