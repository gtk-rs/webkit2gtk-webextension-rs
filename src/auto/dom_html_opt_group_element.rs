...
impl<O: IsA<DOMHTMLOptGroupElement>> DOMHTMLOptGroupElementExt for O {
    fn get_disabled(&self) -> bool {
        unsafe {
            from_glib(
                webkit2_webextension_sys::webkit_dom_html_opt_group_element_get_disabled(
    ...
    fn get_label(&self) -> Option<GString> {
        unsafe {
            from_glib_full(
                webkit2_webextension_sys::webkit_dom_html_opt_group_element_get_label(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn set_disabled(&self, value: bool) {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_opt_group_element_set_disabled(
                self.as_ref().to_glib_none().0,
                value.to_glib(),
            );
        }
    ...
    fn set_label(&self, value: &str) {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_opt_group_element_set_label(
                self.as_ref().to_glib_none().0,
    ...
    fn connect_property_disabled_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_disabled_trampoline<P, F: Fn(&P) + 'static>(
            this: *mut webkit2_webextension_sys::WebKitDOMHTMLOptGroupElement,
