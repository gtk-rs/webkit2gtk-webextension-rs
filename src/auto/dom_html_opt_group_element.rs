...
impl<O: IsA<DOMHTMLOptGroupElement>> DOMHTMLOptGroupElementExt for O {
    ...
    fn set_disabled(&self, value: bool) {
        unsafe {
            ffi::webkit_dom_html_opt_group_element_set_disabled(self.as_ref().to_glib_none().0, value.into_glib());
        }
    }
    ...
    fn connect_disabled_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_disabled_trampoline<P: IsA<DOMHTMLOptGroupElement>, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLOptGroupElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
    ...
    fn connect_label_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_label_trampoline<P: IsA<DOMHTMLOptGroupElement>, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLOptGroupElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(DOMHTMLOptGroupElement::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
