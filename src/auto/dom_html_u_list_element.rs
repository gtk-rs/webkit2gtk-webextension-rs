...
glib::wrapper! {
    ...
    match fn {
        type_ => || ffi::webkit_dom_html_u_list_element_get_type(),
    }
}
...
impl<O: IsA<DOMHTMLUListElement>> DOMHTMLUListElementExt for O {
    ...
    fn set_compact(&self, value: bool) {
        unsafe {
            ffi::webkit_dom_html_u_list_element_set_compact(self.as_ref().to_glib_none().0, value.into_glib());
        }
    }
    ...
    fn connect_compact_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_compact_trampoline<P: IsA<DOMHTMLUListElement>, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLUListElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
    ...
    fn connect_type_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_type_trampoline<P: IsA<DOMHTMLUListElement>, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLUListElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(DOMHTMLUListElement::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
