...
impl<O: IsA<DOMUIEvent>> DOMUIEventExt for O {
    fn get_char_code(&self) -> libc::c_long {
        unsafe {
            webkit2_webextension_sys::webkit_dom_ui_event_get_char_code(
    ...
    fn get_key_code(&self) -> libc::c_long {
        unsafe {
            webkit2_webextension_sys::webkit_dom_ui_event_get_key_code(
                self.as_ref().to_glib_none().0,
            )
        }
    }
    ...
    fn get_layer_x(&self) -> libc::c_long {
        unsafe {
            webkit2_webextension_sys::webkit_dom_ui_event_get_layer_x(
                self.as_ref().to_glib_none().0,
            )
        }
    }
    ...
    fn get_layer_y(&self) -> libc::c_long {
        unsafe {
            webkit2_webextension_sys::webkit_dom_ui_event_get_layer_y(
                self.as_ref().to_glib_none().0,
            )
        }
    }
    ...
    fn get_view(&self) -> Option<DOMDOMWindow> {
        unsafe {
            from_glib_full(webkit2_webextension_sys::webkit_dom_ui_event_get_view(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn init_ui_event<P: IsA<DOMDOMWindow>>(
        ...
        unsafe {
            webkit2_webextension_sys::webkit_dom_ui_event_init_ui_event(
                self.as_ref().to_glib_none().0,
    ...
    fn connect_property_char_code_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_char_code_trampoline<P, F: Fn(&P) + 'static>(
            this: *mut webkit2_webextension_sys::WebKitDOMUIEvent,
    ...
    fn connect_property_detail_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_detail_trampoline<P, F: Fn(&P) + 'static>(
            this: *mut webkit2_webextension_sys::WebKitDOMUIEvent,
            _param_spec: glib_sys::gpointer,
            f: glib_sys::gpointer,
        ) where
    ...
    fn connect_property_key_code_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_key_code_trampoline<P, F: Fn(&P) + 'static>(
            this: *mut webkit2_webextension_sys::WebKitDOMUIEvent,
            _param_spec: glib_sys::gpointer,
            f: glib_sys::gpointer,
        ) where
    ...
    fn connect_property_layer_x_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_layer_x_trampoline<P, F: Fn(&P) + 'static>(
            this: *mut webkit2_webextension_sys::WebKitDOMUIEvent,
            _param_spec: glib_sys::gpointer,
            f: glib_sys::gpointer,
        ) where
    ...
    fn connect_property_layer_y_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_layer_y_trampoline<P, F: Fn(&P) + 'static>(
            this: *mut webkit2_webextension_sys::WebKitDOMUIEvent,
            _param_spec: glib_sys::gpointer,
            f: glib_sys::gpointer,
        ) where
    ...
    fn connect_property_page_x_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_page_x_trampoline<P, F: Fn(&P) + 'static>(
            this: *mut webkit2_webextension_sys::WebKitDOMUIEvent,
            _param_spec: glib_sys::gpointer,
            f: glib_sys::gpointer,
        ) where
    ...
    fn connect_property_page_y_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_page_y_trampoline<P, F: Fn(&P) + 'static>(
            this: *mut webkit2_webextension_sys::WebKitDOMUIEvent,
            _param_spec: glib_sys::gpointer,
            f: glib_sys::gpointer,
        ) where
