...
pub trait DOMDocumentExt {
    ...
    //fn evaluate<T: IsA<DOMNode>, U: IsA</*Ignored*/DOMXPathNSResolver>>(&self, expression: &str, contextNode: &T, resolver: Option<&U>, type_: u16, inResult: Option<&DOMXPathResult>) -> Result<DOMXPathResult, Error>;
