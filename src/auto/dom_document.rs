...
pub trait DOMDocumentExt {
    ...
    fn create_attribute_ns<'a, T: Into<Option<&'a str>>>(&self, namespaceURI: T, qualifiedName: &str) -> Result<DOMAttr, Error>;
    ...
    fn create_element_ns<'a, T: Into<Option<&'a str>>>(&self, namespaceURI: T, qualifiedName: &str) -> Result<DOMElement, Error>;

    fn create_entity_reference<'a, T: Into<Option<&'a str>>>(&self, name: T) -> Result<DOMEntityReference, Error>;
    ...
    //fn create_node_iterator<T: IsA<DOMNode>, U: IsA</*Ignored*/DOMNodeFilter>>(&self, root: &T, whatToShow: libc::c_ulong, filter: Option<&U>, expandEntityReferences: bool) -> Result<DOMNodeIterator, Error>;
    ...
    //fn create_tree_walker<T: IsA<DOMNode>, U: IsA</*Ignored*/DOMNodeFilter>>(&self, root: &T, whatToShow: libc::c_ulong, filter: Option<&U>, expandEntityReferences: bool) -> Result<DOMTreeWalker, Error>;

    fn element_from_point(&self, x: libc::c_long, y: libc::c_long) -> Option<DOMElement>;

    //fn evaluate<T: IsA<DOMNode>, U: IsA</*Ignored*/DOMXPathNSResolver>>(&self, expression: &str, contextNode: &T, resolver: Option<&U>, type_: libc::c_ushort, inResult: Option<&DOMXPathResult>) -> Result<DOMXPathResult, Error>;
    ...
    fn get_override_style<'a, T: IsA<DOMElement>, U: Into<Option<&'a str>>>(&self, element: &T, pseudoElement: U) -> Option<DOMCSSStyleDeclaration>;
...
impl<O: IsA<DOMDocument> + IsA<Object>> DOMDocumentExt for O {
    fn adopt_node<T: IsA<DOMNode>>(&self, source: &T) -> Result<DOMNode, Error> {
        unsafe {
    ...
    fn create_attribute_ns<'a, T: Into<Option<&'a str>>>(&self, namespaceURI: T, qualifiedName: &str) -> Result<DOMAttr, Error> {
        unsafe {
            let mut error = ptr::null_mut();
            let ret = ffi::webkit_dom_document_create_attribute_ns(self.to_glib_none().0, namespaceURI.into().to_glib_none().0, qualifiedName.to_glib_none().0, &mut error);
            if error.is_null() { Ok(from_glib_none(ret)) } else { Err(from_glib_full(error)) }
        }
    }
    ...
    fn create_element_ns<'a, T: Into<Option<&'a str>>>(&self, namespaceURI: T, qualifiedName: &str) -> Result<DOMElement, Error> {
        unsafe {
            let mut error = ptr::null_mut();
            let ret = ffi::webkit_dom_document_create_element_ns(self.to_glib_none().0, namespaceURI.into().to_glib_none().0, qualifiedName.to_glib_none().0, &mut error);
            if error.is_null() { Ok(from_glib_none(ret)) } else { Err(from_glib_full(error)) }
        }
    }
    ...
    fn create_entity_reference<'a, T: Into<Option<&'a str>>>(&self, name: T) -> Result<DOMEntityReference, Error> {
        unsafe {
            let mut error = ptr::null_mut();
            let ret = ffi::webkit_dom_document_create_entity_reference(self.to_glib_none().0, name.into().to_glib_none().0, &mut error);
            if error.is_null() { Ok(from_glib_none(ret)) } else { Err(from_glib_full(error)) }
        }
    }
    ...
    fn get_override_style<'a, T: IsA<DOMElement>, U: Into<Option<&'a str>>>(&self, element: &T, pseudoElement: U) -> Option<DOMCSSStyleDeclaration> {
        unsafe {
            from_glib_full(ffi::webkit_dom_document_get_override_style(self.to_glib_none().0, element.to_glib_none().0, pseudoElement.into().to_glib_none().0))
        }
    }
