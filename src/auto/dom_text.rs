...
pub trait DOMTextExt: 'static {
    ...
    fn get_whole_text(&self) -> Option<glib::GString>;
...
impl<O: IsA<DOMText>> DOMTextExt for O {
    ...
    fn connect_property_whole_text_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_whole_text_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMText, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMText>
        {
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::whole-text\0".as_ptr() as *const _,
                Some(transmute::<_, unsafe extern "C" fn()>(notify_whole_text_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
}
