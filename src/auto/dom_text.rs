...
impl<O: IsA<DOMText>> DOMTextExt for O {
    fn get_whole_text(&self) -> Option<GString> {
        unsafe {
            from_glib_full(webkit2_webextension_sys::webkit_dom_text_get_whole_text(
    ...
    fn replace_whole_text(&self, content: &str) -> Result<DOMText, glib::Error> {
        unsafe {
            ...
            let ret = webkit2_webextension_sys::webkit_dom_text_replace_whole_text(
                self.as_ref().to_glib_none().0,
    ...
    fn split_text(&self, offset: libc::c_ulong) -> Result<DOMText, glib::Error> {
        unsafe {
            let mut error = ptr::null_mut();
            let ret = webkit2_webextension_sys::webkit_dom_text_split_text(
                self.as_ref().to_glib_none().0,
                offset,
                &mut error,
            );
    ...
    fn connect_property_whole_text_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_whole_text_trampoline<P, F: Fn(&P) + 'static>(
            this: *mut webkit2_webextension_sys::WebKitDOMText,
        ...
        unsafe {
            ...
            connect_raw(
                ...
                Some(transmute(notify_whole_text_trampoline::<Self, F> as usize)),
                Box_::into_raw(f),
            )
        }
    }
