...
impl<O: IsA<DOMHTMLCanvasElement>> DOMHTMLCanvasElementExt for O {
    fn get_height(&self) -> libc::c_long {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_canvas_element_get_height(
    ...
    fn get_width(&self) -> libc::c_long {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_canvas_element_get_width(
                self.as_ref().to_glib_none().0,
            )
        }
    }
    ...
    fn set_height(&self, value: libc::c_long) {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_canvas_element_set_height(
                self.as_ref().to_glib_none().0,
                value,
            );
        }
    ...
    fn set_width(&self, value: libc::c_long) {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_canvas_element_set_width(
                self.as_ref().to_glib_none().0,
                value,
            );
        }
    ...
    fn connect_property_height_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_height_trampoline<P, F: Fn(&P) + 'static>(
            this: *mut webkit2_webextension_sys::WebKitDOMHTMLCanvasElement,
