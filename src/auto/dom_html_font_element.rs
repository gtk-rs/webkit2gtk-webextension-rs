...
unsafe extern "C" fn notify_color_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLFontElement, _param_spec: glib_ffi::gpointer, f: glib_ffi::gpointer)
where P: IsA<DOMHTMLFontElement> {
    let f: &F = &*(f as *const F);
    f(&DOMHTMLFontElement::from_glib_borrow(this).unsafe_cast())
}

unsafe extern "C" fn notify_face_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLFontElement, _param_spec: glib_ffi::gpointer, f: glib_ffi::gpointer)
where P: IsA<DOMHTMLFontElement> {
    let f: &F = &*(f as *const F);
    f(&DOMHTMLFontElement::from_glib_borrow(this).unsafe_cast())
}

unsafe extern "C" fn notify_size_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLFontElement, _param_spec: glib_ffi::gpointer, f: glib_ffi::gpointer)
where P: IsA<DOMHTMLFontElement> {
    let f: &F = &*(f as *const F);
    f(&DOMHTMLFontElement::from_glib_borrow(this).unsafe_cast())
}
