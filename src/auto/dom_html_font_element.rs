...
impl<O: IsA<DOMHTMLFontElement>> DOMHTMLFontElementExt for O {
    ...
    fn connect_color_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_color_trampoline<P: IsA<DOMHTMLFontElement>, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLFontElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
    ...
    fn connect_face_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_face_trampoline<P: IsA<DOMHTMLFontElement>, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLFontElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(DOMHTMLFontElement::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_size_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_size_trampoline<P: IsA<DOMHTMLFontElement>, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLFontElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(DOMHTMLFontElement::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
