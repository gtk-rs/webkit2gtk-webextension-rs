...
impl ContextMenuItem {
    ...
    pub fn new_from_gaction<P: IsA<gio::Action>>(action: &P, label: &str, target: Option<&glib::Variant>) -> ContextMenuItem {
        ...
        unsafe {
            from_glib_none(webkit2_webextension_sys::webkit_context_menu_item_new_from_gaction(action.as_ref().to_glib_none().0, label.to_glib_none().0, target.to_glib_none().0))
        }
    }
    ...
    pub fn new_from_stock_action(action: ContextMenuAction) -> ContextMenuItem {
        assert_initialized_main_thread!();
        unsafe {
            from_glib_none(webkit2_webextension_sys::webkit_context_menu_item_new_from_stock_action(action.to_glib()))
        }
    }
    ...
    pub fn new_from_stock_action_with_label(action: ContextMenuAction, label: &str) -> ContextMenuItem {
        assert_initialized_main_thread!();
        unsafe {
            from_glib_none(webkit2_webextension_sys::webkit_context_menu_item_new_from_stock_action_with_label(action.to_glib(), label.to_glib_none().0))
        }
    }
    ...
    pub fn new_with_submenu<P: IsA<ContextMenu>>(label: &str, submenu: &P) -> ContextMenuItem {
        ...
        unsafe {
            from_glib_none(webkit2_webextension_sys::webkit_context_menu_item_new_with_submenu(label.to_glib_none().0, submenu.as_ref().to_glib_none().0))
        }
    }
}
...
impl<O: IsA<ContextMenuItem>> ContextMenuItemExt for O {
    ...
    fn get_gaction(&self) -> Option<gio::Action> {
        unsafe {
            from_glib_none(webkit2_webextension_sys::webkit_context_menu_item_get_gaction(self.as_ref().to_glib_none().0))
        }
    }

    fn get_stock_action(&self) -> ContextMenuAction {
        unsafe {
            from_glib(webkit2_webextension_sys::webkit_context_menu_item_get_stock_action(self.as_ref().to_glib_none().0))
        }
    }

    fn get_submenu(&self) -> Option<ContextMenu> {
        unsafe {
            from_glib_none(webkit2_webextension_sys::webkit_context_menu_item_get_submenu(self.as_ref().to_glib_none().0))
        }
    }

    fn is_separator(&self) -> bool {
        unsafe {
            from_glib(webkit2_webextension_sys::webkit_context_menu_item_is_separator(self.as_ref().to_glib_none().0))
        }
    }

    fn set_submenu<P: IsA<ContextMenu>>(&self, submenu: Option<&P>) {
        unsafe {
            webkit2_webextension_sys::webkit_context_menu_item_set_submenu(self.as_ref().to_glib_none().0, submenu.map(|p| p.as_ref()).to_glib_none().0);
        }
    }
}
