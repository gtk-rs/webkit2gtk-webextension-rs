...
impl<O: IsA<DOMEventTarget>> DOMEventTargetExt for O {
    ...
    fn add_event_listener_with_closure(&self, event_name: &str, handler: &glib::Closure, use_capture: bool) -> bool {
        unsafe {
            from_glib(ffi::webkit_dom_event_target_add_event_listener_with_closure(self.to_glib_none().0, event_name.to_glib_none().0, handler.to_glib_none().0 as *mut _, use_capture.to_glib()))
        }
    }
    ...
    fn remove_event_listener_with_closure(&self, event_name: &str, handler: &glib::Closure, use_capture: bool) -> bool {
        unsafe {
            from_glib(ffi::webkit_dom_event_target_remove_event_listener_with_closure(self.to_glib_none().0, event_name.to_glib_none().0, handler.to_glib_none().0 as *mut _, use_capture.to_glib()))
        }
    }
}
