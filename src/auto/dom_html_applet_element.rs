...
pub trait DOMHTMLAppletElementExt: 'static {
    ...
    fn get_object(&self) -> Option<glib::GString>;
...
impl<O: IsA<DOMHTMLAppletElement>> DOMHTMLAppletElementExt for O {
    ...
    fn connect_property_align_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_align_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLAppletElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
    ...
    fn connect_property_alt_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_alt_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLAppletElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLAppletElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLAppletElement::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_archive_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_archive_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLAppletElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLAppletElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLAppletElement::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_code_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_code_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLAppletElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLAppletElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLAppletElement::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_code_base_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_code_base_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLAppletElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLAppletElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLAppletElement::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_height_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_height_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLAppletElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLAppletElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLAppletElement::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_hspace_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_hspace_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLAppletElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLAppletElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLAppletElement::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_name_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_name_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLAppletElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLAppletElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLAppletElement::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_object_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_object_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLAppletElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLAppletElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLAppletElement::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_vspace_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_vspace_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLAppletElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLAppletElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLAppletElement::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_width_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_width_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLAppletElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLAppletElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLAppletElement::from_glib_borrow(this).unsafe_cast_ref())
