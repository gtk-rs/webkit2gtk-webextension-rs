...
impl<O: IsA<DOMRange>> DOMRangeExt for O {
    ...
    fn clone_contents(&self) -> Result<DOMDocumentFragment, glib::Error> {
        unsafe {
            ...
            let ret =
                ffi::webkit_dom_range_clone_contents(self.as_ref().to_glib_none().0, &mut error);
            if error.is_null() {
    ...
    fn collapse(&self, toStart: bool) -> Result<(), glib::Error> {
        unsafe {
            let mut error = ptr::null_mut();
            let _ = ffi::webkit_dom_range_collapse(
    ...
    fn compare_boundary_points<P: IsA<DOMRange>>(
        ...
        unsafe {
            let mut error = ptr::null_mut();
            let ret = ffi::webkit_dom_range_compare_boundary_points(
                self.as_ref().to_glib_none().0,
                how,
    ...
    fn compare_node<P: IsA<DOMNode>>(&self, refNode: &P) -> Result<libc::c_short, glib::Error> {
        unsafe {
            let mut error = ptr::null_mut();
            let ret = ffi::webkit_dom_range_compare_node(
                self.as_ref().to_glib_none().0,
    ...
    fn compare_point<P: IsA<DOMNode>>(
        ...
        unsafe {
            let mut error = ptr::null_mut();
            let ret = ffi::webkit_dom_range_compare_point(
                self.as_ref().to_glib_none().0,
                refNode.as_ref().to_glib_none().0,
                offset,
                &mut error,
    ...
    fn create_contextual_fragment(&self, html: &str) -> Result<DOMDocumentFragment, glib::Error> {
        unsafe {
            let mut error = ptr::null_mut();
            let ret = ffi::webkit_dom_range_create_contextual_fragment(
                self.as_ref().to_glib_none().0,
                html.to_glib_none().0,
                &mut error,
            );
    ...
    fn delete_contents(&self) -> Result<(), glib::Error> {
        unsafe {
            let mut error = ptr::null_mut();
            let _ =
                ffi::webkit_dom_range_delete_contents(self.as_ref().to_glib_none().0, &mut error);
            if error.is_null() {
                Ok(())
            } else {
                Err(from_glib_full(error))
    ...
    fn expand(&self, unit: &str) -> Result<(), glib::Error> {
        unsafe {
            let mut error = ptr::null_mut();
            let _ = ffi::webkit_dom_range_expand(
                self.as_ref().to_glib_none().0,
                unit.to_glib_none().0,
                &mut error,
            );
    ...
    fn extract_contents(&self) -> Result<DOMDocumentFragment, glib::Error> {
        unsafe {
            let mut error = ptr::null_mut();
            let ret =
                ffi::webkit_dom_range_extract_contents(self.as_ref().to_glib_none().0, &mut error);
            if error.is_null() {
                Ok(from_glib_none(ret))
            } else {
                Err(from_glib_full(error))
    ...
    fn common_ancestor_container(&self) -> Result<DOMNode, glib::Error> {
        unsafe {
            let mut error = ptr::null_mut();
            let ret = ffi::webkit_dom_range_get_common_ancestor_container(
                self.as_ref().to_glib_none().0,
                &mut error,
            );
            if error.is_null() {
    ...
    fn end_container(&self) -> Result<DOMNode, glib::Error> {
        unsafe {
            let mut error = ptr::null_mut();
            let ret =
                ffi::webkit_dom_range_get_end_container(self.as_ref().to_glib_none().0, &mut error);
            if error.is_null() {
                Ok(from_glib_none(ret))
            } else {
                Err(from_glib_full(error))
    ...
    fn end_offset(&self) -> Result<libc::c_long, glib::Error> {
        unsafe {
            let mut error = ptr::null_mut();
            let ret =
                ffi::webkit_dom_range_get_end_offset(self.as_ref().to_glib_none().0, &mut error);
            if error.is_null() {
                Ok(ret)
            } else {
                Err(from_glib_full(error))
    ...
    fn start_container(&self) -> Result<DOMNode, glib::Error> {
        unsafe {
            let mut error = ptr::null_mut();
            let ret = ffi::webkit_dom_range_get_start_container(
                self.as_ref().to_glib_none().0,
                &mut error,
            );
            if error.is_null() {
    ...
    fn start_offset(&self) -> Result<libc::c_long, glib::Error> {
        unsafe {
            let mut error = ptr::null_mut();
            let ret =
                ffi::webkit_dom_range_get_start_offset(self.as_ref().to_glib_none().0, &mut error);
            if error.is_null() {
                Ok(ret)
            } else {
                Err(from_glib_full(error))
    ...
    fn insert_node<P: IsA<DOMNode>>(&self, newNode: &P) -> Result<(), glib::Error> {
        unsafe {
            let mut error = ptr::null_mut();
            let _ = ffi::webkit_dom_range_insert_node(
                self.as_ref().to_glib_none().0,
    ...
    fn intersects_node<P: IsA<DOMNode>>(&self, refNode: &P) -> Result<(), glib::Error> {
        unsafe {
            let mut error = ptr::null_mut();
            let _ = ffi::webkit_dom_range_intersects_node(
                self.as_ref().to_glib_none().0,
                refNode.as_ref().to_glib_none().0,
                &mut error,
            );
    ...
    fn is_point_in_range<P: IsA<DOMNode>>(
        ...
        unsafe {
            let mut error = ptr::null_mut();
            let _ = ffi::webkit_dom_range_is_point_in_range(
                self.as_ref().to_glib_none().0,
                refNode.as_ref().to_glib_none().0,
                offset,
                &mut error,
    ...
    fn select_node<P: IsA<DOMNode>>(&self, refNode: &P) -> Result<(), glib::Error> {
        unsafe {
            let mut error = ptr::null_mut();
            let _ = ffi::webkit_dom_range_select_node(
                self.as_ref().to_glib_none().0,
                refNode.as_ref().to_glib_none().0,
                &mut error,
            );
    ...
    fn select_node_contents<P: IsA<DOMNode>>(&self, refNode: &P) -> Result<(), glib::Error> {
        unsafe {
            let mut error = ptr::null_mut();
            let _ = ffi::webkit_dom_range_select_node_contents(
                self.as_ref().to_glib_none().0,
                refNode.as_ref().to_glib_none().0,
                &mut error,
            );
    ...
    fn set_end<P: IsA<DOMNode>>(
        ...
        unsafe {
            let mut error = ptr::null_mut();
            let _ = ffi::webkit_dom_range_set_end(
                self.as_ref().to_glib_none().0,
                refNode.as_ref().to_glib_none().0,
                offset,
                &mut error,
    ...
    fn set_end_after<P: IsA<DOMNode>>(&self, refNode: &P) -> Result<(), glib::Error> {
        unsafe {
            let mut error = ptr::null_mut();
            let _ = ffi::webkit_dom_range_set_end_after(
                self.as_ref().to_glib_none().0,
                refNode.as_ref().to_glib_none().0,
                &mut error,
            );
    ...
    fn set_end_before<P: IsA<DOMNode>>(&self, refNode: &P) -> Result<(), glib::Error> {
        unsafe {
            let mut error = ptr::null_mut();
            let _ = ffi::webkit_dom_range_set_end_before(
                self.as_ref().to_glib_none().0,
                refNode.as_ref().to_glib_none().0,
                &mut error,
            );
    ...
    fn set_start<P: IsA<DOMNode>>(
        ...
        unsafe {
            let mut error = ptr::null_mut();
            let _ = ffi::webkit_dom_range_set_start(
                self.as_ref().to_glib_none().0,
                refNode.as_ref().to_glib_none().0,
                offset,
                &mut error,
    ...
    fn set_start_after<P: IsA<DOMNode>>(&self, refNode: &P) -> Result<(), glib::Error> {
        unsafe {
            let mut error = ptr::null_mut();
            let _ = ffi::webkit_dom_range_set_start_after(
                self.as_ref().to_glib_none().0,
                refNode.as_ref().to_glib_none().0,
                &mut error,
            );
    ...
    fn set_start_before<P: IsA<DOMNode>>(&self, refNode: &P) -> Result<(), glib::Error> {
        unsafe {
            let mut error = ptr::null_mut();
            let _ = ffi::webkit_dom_range_set_start_before(
                self.as_ref().to_glib_none().0,
                refNode.as_ref().to_glib_none().0,
                &mut error,
            );
    ...
    fn surround_contents<P: IsA<DOMNode>>(&self, newParent: &P) -> Result<(), glib::Error> {
        unsafe {
            let mut error = ptr::null_mut();
            let _ = ffi::webkit_dom_range_surround_contents(
                self.as_ref().to_glib_none().0,
