...
impl DOMRange {
    ...
    pub fn compare_node<T: IsA<DOMNode>>(&self, refNode: &T) -> Result<libc::c_short, Error> {
        unsafe {
            let mut error = ptr::null_mut();
    ...
    pub fn compare_point<T: IsA<DOMNode>>(&self, refNode: &T, offset: libc::c_long) -> Result<libc::c_short, Error> {
        unsafe {
            let mut error = ptr::null_mut();
    ...
    pub fn is_point_in_range<T: IsA<DOMNode>>(&self, refNode: &T, offset: libc::c_long) -> Result<(), Error> {
        unsafe {
            let mut error = ptr::null_mut();
    ...
    pub fn set_end<T: IsA<DOMNode>>(&self, refNode: &T, offset: libc::c_long) -> Result<(), Error> {
        unsafe {
            let mut error = ptr::null_mut();
    ...
    pub fn set_start<T: IsA<DOMNode>>(&self, refNode: &T, offset: libc::c_long) -> Result<(), Error> {
        unsafe {
            let mut error = ptr::null_mut();
