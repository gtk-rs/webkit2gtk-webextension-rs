...
impl DOMRange {
    ...
    pub fn compare_boundary_points(&self, how: libc::c_ushort, sourceRange: &DOMRange) -> Result<libc::c_short, Error> {
        unsafe {
            let mut error = ptr::null_mut();
    ...
    pub fn compare_node<P: IsA<DOMNode>>(&self, refNode: &P) -> Result<libc::c_short, Error> {
        unsafe {
            let mut error = ptr::null_mut();
    ...
    pub fn compare_point<P: IsA<DOMNode>>(&self, refNode: &P, offset: libc::c_long) -> Result<libc::c_short, Error> {
        unsafe {
            let mut error = ptr::null_mut();
    ...
    #[cfg(feature = "v2_16")]
    pub fn expand(&self, unit: &str) -> Result<(), Error> {
        unsafe {
            let mut error = ptr::null_mut();
    ...
    pub fn get_end_offset(&self) -> Result<libc::c_long, Error> {
        unsafe {
            let mut error = ptr::null_mut();
    ...
    pub fn get_start_offset(&self) -> Result<libc::c_long, Error> {
        unsafe {
            let mut error = ptr::null_mut();
    ...
    pub fn insert_node<P: IsA<DOMNode>>(&self, newNode: &P) -> Result<(), Error> {
        unsafe {
            let mut error = ptr::null_mut();
    ...
    pub fn intersects_node<P: IsA<DOMNode>>(&self, refNode: &P) -> Result<(), Error> {
        unsafe {
            let mut error = ptr::null_mut();
    ...
    pub fn is_point_in_range<P: IsA<DOMNode>>(&self, refNode: &P, offset: libc::c_long) -> Result<(), Error> {
        unsafe {
            let mut error = ptr::null_mut();
    ...
    pub fn select_node<P: IsA<DOMNode>>(&self, refNode: &P) -> Result<(), Error> {
        unsafe {
            let mut error = ptr::null_mut();
    ...
    pub fn select_node_contents<P: IsA<DOMNode>>(&self, refNode: &P) -> Result<(), Error> {
        unsafe {
            let mut error = ptr::null_mut();
    ...
    pub fn set_end<P: IsA<DOMNode>>(&self, refNode: &P, offset: libc::c_long) -> Result<(), Error> {
        unsafe {
            let mut error = ptr::null_mut();
    ...
    pub fn set_end_after<P: IsA<DOMNode>>(&self, refNode: &P) -> Result<(), Error> {
        unsafe {
            let mut error = ptr::null_mut();
    ...
    pub fn set_end_before<P: IsA<DOMNode>>(&self, refNode: &P) -> Result<(), Error> {
        unsafe {
            let mut error = ptr::null_mut();
    ...
    pub fn set_start<P: IsA<DOMNode>>(&self, refNode: &P, offset: libc::c_long) -> Result<(), Error> {
        unsafe {
            let mut error = ptr::null_mut();
    ...
    pub fn set_start_after<P: IsA<DOMNode>>(&self, refNode: &P) -> Result<(), Error> {
        unsafe {
            let mut error = ptr::null_mut();
    ...
    pub fn set_start_before<P: IsA<DOMNode>>(&self, refNode: &P) -> Result<(), Error> {
        unsafe {
            let mut error = ptr::null_mut();
    ...
    pub fn surround_contents<P: IsA<DOMNode>>(&self, newParent: &P) -> Result<(), Error> {
        unsafe {
            let mut error = ptr::null_mut();
