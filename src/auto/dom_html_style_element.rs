...
impl<O: IsA<DOMHTMLStyleElement>> DOMHTMLStyleElementExt for O {
    ...
    fn connect_property_disabled_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_disabled_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLStyleElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
    ...
    fn connect_property_media_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_media_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLStyleElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLStyleElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLStyleElement::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_sheet_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_sheet_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLStyleElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLStyleElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLStyleElement::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_type_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_type_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLStyleElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLStyleElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLStyleElement::from_glib_borrow(this).unsafe_cast_ref())
