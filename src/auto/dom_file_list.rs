...
impl<O: IsA<DOMFileList>> DOMFileListExt for O {
    ...
    fn connect_length_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_length_trampoline<P: IsA<DOMFileList>, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMFileList, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
