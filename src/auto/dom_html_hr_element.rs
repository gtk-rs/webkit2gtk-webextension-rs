...
glib_wrapper! {
    pub struct DOMHTMLHRElement(Object<ffi::WebKitDOMHTMLHRElement, ffi::WebKitDOMHTMLHRElementClass>): DOMHTMLElement, DOMElement, DOMNode, DOMObject, DOMEventTarget;
