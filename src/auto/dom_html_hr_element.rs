...
unsafe extern "C" fn notify_align_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLHRElement, _param_spec: glib_ffi::gpointer, f: glib_ffi::gpointer)
where P: IsA<DOMHTMLHRElement> {
    let f: &F = &*(f as *const F);
    f(&DOMHTMLHRElement::from_glib_borrow(this).unsafe_cast())
}

unsafe extern "C" fn notify_no_shade_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLHRElement, _param_spec: glib_ffi::gpointer, f: glib_ffi::gpointer)
where P: IsA<DOMHTMLHRElement> {
    let f: &F = &*(f as *const F);
    f(&DOMHTMLHRElement::from_glib_borrow(this).unsafe_cast())
}

unsafe extern "C" fn notify_size_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLHRElement, _param_spec: glib_ffi::gpointer, f: glib_ffi::gpointer)
where P: IsA<DOMHTMLHRElement> {
    let f: &F = &*(f as *const F);
    f(&DOMHTMLHRElement::from_glib_borrow(this).unsafe_cast())
}

unsafe extern "C" fn notify_width_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLHRElement, _param_spec: glib_ffi::gpointer, f: glib_ffi::gpointer)
where P: IsA<DOMHTMLHRElement> {
    let f: &F = &*(f as *const F);
    f(&DOMHTMLHRElement::from_glib_borrow(this).unsafe_cast())
}
