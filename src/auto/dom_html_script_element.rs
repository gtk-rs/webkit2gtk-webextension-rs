...
unsafe extern "C" fn notify_charset_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLScriptElement, _param_spec: glib_ffi::gpointer, f: glib_ffi::gpointer)
where P: IsA<DOMHTMLScriptElement> {
    let f: &F = &*(f as *const F);
    f(&DOMHTMLScriptElement::from_glib_borrow(this).unsafe_cast())
}

unsafe extern "C" fn notify_defer_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLScriptElement, _param_spec: glib_ffi::gpointer, f: glib_ffi::gpointer)
where P: IsA<DOMHTMLScriptElement> {
    let f: &F = &*(f as *const F);
    f(&DOMHTMLScriptElement::from_glib_borrow(this).unsafe_cast())
}

unsafe extern "C" fn notify_event_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLScriptElement, _param_spec: glib_ffi::gpointer, f: glib_ffi::gpointer)
where P: IsA<DOMHTMLScriptElement> {
    let f: &F = &*(f as *const F);
    f(&DOMHTMLScriptElement::from_glib_borrow(this).unsafe_cast())
}

unsafe extern "C" fn notify_html_for_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLScriptElement, _param_spec: glib_ffi::gpointer, f: glib_ffi::gpointer)
where P: IsA<DOMHTMLScriptElement> {
    let f: &F = &*(f as *const F);
    f(&DOMHTMLScriptElement::from_glib_borrow(this).unsafe_cast())
}

unsafe extern "C" fn notify_src_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLScriptElement, _param_spec: glib_ffi::gpointer, f: glib_ffi::gpointer)
where P: IsA<DOMHTMLScriptElement> {
    let f: &F = &*(f as *const F);
    f(&DOMHTMLScriptElement::from_glib_borrow(this).unsafe_cast())
}

unsafe extern "C" fn notify_text_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLScriptElement, _param_spec: glib_ffi::gpointer, f: glib_ffi::gpointer)
where P: IsA<DOMHTMLScriptElement> {
    let f: &F = &*(f as *const F);
    f(&DOMHTMLScriptElement::from_glib_borrow(this).unsafe_cast())
}

unsafe extern "C" fn notify_type_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLScriptElement, _param_spec: glib_ffi::gpointer, f: glib_ffi::gpointer)
where P: IsA<DOMHTMLScriptElement> {
    let f: &F = &*(f as *const F);
    f(&DOMHTMLScriptElement::from_glib_borrow(this).unsafe_cast())
}
