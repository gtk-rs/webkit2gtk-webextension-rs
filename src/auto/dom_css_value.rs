...
impl<O: IsA<DOMCSSValue>> DOMCSSValueExt for O {
    fn get_css_text(&self) -> Option<GString> {
        unsafe {
            from_glib_full(webkit2_webextension_sys::webkit_dom_css_value_get_css_text(
    ...
    fn get_css_value_type(&self) -> libc::c_ushort {
        unsafe {
            webkit2_webextension_sys::webkit_dom_css_value_get_css_value_type(
                self.as_ref().to_glib_none().0,
            )
        }
    }
    ...
    fn set_css_text(&self, value: &str) -> Result<(), glib::Error> {
        unsafe {
            ...
            let _ = webkit2_webextension_sys::webkit_dom_css_value_set_css_text(
                self.as_ref().to_glib_none().0,
    ...
    fn connect_property_css_text_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_css_text_trampoline<P, F: Fn(&P) + 'static>(
            this: *mut webkit2_webextension_sys::WebKitDOMCSSValue,
    ...
    fn connect_property_css_value_type_notify<F: Fn(&Self) + 'static>(
        ...
        unsafe {
            ...
            connect_raw(
                ...
                Some(transmute(
                    notify_css_value_type_trampoline::<Self, F> as usize,
                )),
                Box_::into_raw(f),
            )
        }
