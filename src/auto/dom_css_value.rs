...
impl<O: IsA<DOMCSSValue>> DOMCSSValueExt for O {
    ...
    fn connect_property_css_text_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_css_text_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMCSSValue, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
    ...
    fn connect_property_css_value_type_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_css_value_type_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMCSSValue, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMCSSValue>
        {
            let f: &F = &*(f as *const F);
            f(&DOMCSSValue::from_glib_borrow(this).unsafe_cast_ref())
