...
glib_wrapper! {
    pub struct DOMNodeList(Object<ffi::WebKitDOMNodeList, ffi::WebKitDOMNodeListClass>): DOMObject;
...
impl<O: IsA<DOMNodeList> + IsA<glib::object::Object>> DOMNodeListExt for O {
    fn get_length(&self) -> libc::c_ulong {
        unsafe {
...
where P: IsA<DOMNodeList> {
    ...
    f(&DOMNodeList::from_glib_borrow(this).downcast_unchecked())
}
