...
impl<O: IsA<DOMHTMLMapElement>> DOMHTMLMapElementExt for O {
    ...
    fn connect_property_areas_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_areas_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLMapElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
    ...
    fn connect_property_name_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_name_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLMapElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLMapElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLMapElement::from_glib_borrow(this).unsafe_cast_ref())
