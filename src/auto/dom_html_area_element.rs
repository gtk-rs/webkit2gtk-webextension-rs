...
impl<O: IsA<DOMHTMLAreaElement>> DOMHTMLAreaElementExt for O {
    fn get_alt(&self) -> Option<GString> {
        unsafe {
            from_glib_full(
                webkit2_webextension_sys::webkit_dom_html_area_element_get_alt(
    ...
    fn get_coords(&self) -> Option<GString> {
        unsafe {
            from_glib_full(
                webkit2_webextension_sys::webkit_dom_html_area_element_get_coords(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn get_hash(&self) -> Option<GString> {
        unsafe {
            from_glib_full(
                webkit2_webextension_sys::webkit_dom_html_area_element_get_hash(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn get_host(&self) -> Option<GString> {
        unsafe {
            from_glib_full(
                webkit2_webextension_sys::webkit_dom_html_area_element_get_host(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn get_hostname(&self) -> Option<GString> {
        unsafe {
            from_glib_full(
                webkit2_webextension_sys::webkit_dom_html_area_element_get_hostname(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn get_href(&self) -> Option<GString> {
        unsafe {
            from_glib_full(
                webkit2_webextension_sys::webkit_dom_html_area_element_get_href(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn get_no_href(&self) -> bool {
        unsafe {
            from_glib(
                webkit2_webextension_sys::webkit_dom_html_area_element_get_no_href(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn get_pathname(&self) -> Option<GString> {
        unsafe {
            from_glib_full(
                webkit2_webextension_sys::webkit_dom_html_area_element_get_pathname(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn get_port(&self) -> Option<GString> {
        unsafe {
            from_glib_full(
                webkit2_webextension_sys::webkit_dom_html_area_element_get_port(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn get_protocol(&self) -> Option<GString> {
        unsafe {
            from_glib_full(
                webkit2_webextension_sys::webkit_dom_html_area_element_get_protocol(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn get_search(&self) -> Option<GString> {
        unsafe {
            from_glib_full(
                webkit2_webextension_sys::webkit_dom_html_area_element_get_search(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn get_shape(&self) -> Option<GString> {
        unsafe {
            from_glib_full(
                webkit2_webextension_sys::webkit_dom_html_area_element_get_shape(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn get_target(&self) -> Option<GString> {
        unsafe {
            from_glib_full(
                webkit2_webextension_sys::webkit_dom_html_area_element_get_target(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn set_alt(&self, value: &str) {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_area_element_set_alt(
                self.as_ref().to_glib_none().0,
    ...
    fn set_coords(&self, value: &str) {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_area_element_set_coords(
                self.as_ref().to_glib_none().0,
                value.to_glib_none().0,
            );
        }
    ...
    fn set_hash(&self, value: &str) {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_area_element_set_hash(
                self.as_ref().to_glib_none().0,
                value.to_glib_none().0,
            );
        }
    ...
    fn set_host(&self, value: &str) {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_area_element_set_host(
                self.as_ref().to_glib_none().0,
                value.to_glib_none().0,
            );
        }
    ...
    fn set_hostname(&self, value: &str) {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_area_element_set_hostname(
                self.as_ref().to_glib_none().0,
                value.to_glib_none().0,
            );
        }
    ...
    fn set_href(&self, value: &str) {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_area_element_set_href(
                self.as_ref().to_glib_none().0,
                value.to_glib_none().0,
            );
        }
    ...
    fn set_no_href(&self, value: bool) {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_area_element_set_no_href(
                self.as_ref().to_glib_none().0,
                value.to_glib(),
            );
        }
    ...
    fn set_pathname(&self, value: &str) {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_area_element_set_pathname(
                self.as_ref().to_glib_none().0,
                value.to_glib_none().0,
            );
        }
    ...
    fn set_port(&self, value: &str) {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_area_element_set_port(
                self.as_ref().to_glib_none().0,
                value.to_glib_none().0,
            );
        }
    ...
    fn set_protocol(&self, value: &str) {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_area_element_set_protocol(
                self.as_ref().to_glib_none().0,
                value.to_glib_none().0,
            );
        }
    ...
    fn set_search(&self, value: &str) {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_area_element_set_search(
                self.as_ref().to_glib_none().0,
                value.to_glib_none().0,
            );
        }
    ...
    fn set_shape(&self, value: &str) {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_area_element_set_shape(
                self.as_ref().to_glib_none().0,
                value.to_glib_none().0,
            );
        }
    ...
    fn set_target(&self, value: &str) {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_area_element_set_target(
                self.as_ref().to_glib_none().0,
                value.to_glib_none().0,
            );
        }
    ...
    fn set_property_host(&self, host: Option<&str>) {
        unsafe {
            gobject_sys::g_object_set_property(
                ...
                Value::from(host).to_glib_none().0,
            );
        }
    }
    ...
    fn set_property_hostname(&self, hostname: Option<&str>) {
        unsafe {
            gobject_sys::g_object_set_property(
                ...
                Value::from(hostname).to_glib_none().0,
            );
        }
    }
    ...
    fn set_property_pathname(&self, pathname: Option<&str>) {
        unsafe {
            gobject_sys::g_object_set_property(
                ...
                Value::from(pathname).to_glib_none().0,
            );
        }
    }
    ...
    fn set_property_search(&self, search: Option<&str>) {
        unsafe {
            gobject_sys::g_object_set_property(
                ...
                Value::from(search).to_glib_none().0,
            );
        }
    }
    ...
    fn connect_property_alt_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_alt_trampoline<P, F: Fn(&P) + 'static>(
            this: *mut webkit2_webextension_sys::WebKitDOMHTMLAreaElement,
