...
impl<O: IsA<DOMDocumentType>> DOMDocumentTypeExt for O {
    fn get_entities(&self) -> Option<DOMNamedNodeMap> {
        unsafe {
            from_glib_full(
                webkit2_webextension_sys::webkit_dom_document_type_get_entities(
    ...
    fn get_internal_subset(&self) -> Option<GString> {
        unsafe {
            from_glib_full(
                webkit2_webextension_sys::webkit_dom_document_type_get_internal_subset(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn get_name(&self) -> Option<GString> {
        unsafe {
            from_glib_full(webkit2_webextension_sys::webkit_dom_document_type_get_name(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn get_notations(&self) -> Option<DOMNamedNodeMap> {
        unsafe {
            from_glib_full(
                webkit2_webextension_sys::webkit_dom_document_type_get_notations(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn get_public_id(&self) -> Option<GString> {
        unsafe {
            from_glib_full(
                webkit2_webextension_sys::webkit_dom_document_type_get_public_id(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn get_system_id(&self) -> Option<GString> {
        unsafe {
            from_glib_full(
                webkit2_webextension_sys::webkit_dom_document_type_get_system_id(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn connect_property_entities_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_entities_trampoline<P, F: Fn(&P) + 'static>(
            this: *mut webkit2_webextension_sys::WebKitDOMDocumentType,
