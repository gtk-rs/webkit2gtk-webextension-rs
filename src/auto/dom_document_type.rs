...
glib_wrapper! {
    pub struct DOMDocumentType(Object<ffi::WebKitDOMDocumentType>);
...
impl DOMDocumentType {
    //pub fn get_entities(&self) -> /*Ignored*/Option<DOMNamedNodeMap> {
    //    unsafe { TODO: call ffi::webkit_dom_document_type_get_entities() }
    //}
    ...
    //pub fn get_notations(&self) -> /*Ignored*/Option<DOMNamedNodeMap> {
    //    unsafe { TODO: call ffi::webkit_dom_document_type_get_notations() }
    //}
