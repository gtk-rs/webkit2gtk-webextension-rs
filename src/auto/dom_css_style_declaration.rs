...
unsafe extern "C" fn notify_css_text_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMCSSStyleDeclaration, _param_spec: glib_ffi::gpointer, f: glib_ffi::gpointer)
where P: IsA<DOMCSSStyleDeclaration> {
    let f: &F = &*(f as *const F);
    f(&DOMCSSStyleDeclaration::from_glib_borrow(this).unsafe_cast())
}

unsafe extern "C" fn notify_length_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMCSSStyleDeclaration, _param_spec: glib_ffi::gpointer, f: glib_ffi::gpointer)
where P: IsA<DOMCSSStyleDeclaration> {
    let f: &F = &*(f as *const F);
    f(&DOMCSSStyleDeclaration::from_glib_borrow(this).unsafe_cast())
}

unsafe extern "C" fn notify_parent_rule_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMCSSStyleDeclaration, _param_spec: glib_ffi::gpointer, f: glib_ffi::gpointer)
where P: IsA<DOMCSSStyleDeclaration> {
    let f: &F = &*(f as *const F);
    f(&DOMCSSStyleDeclaration::from_glib_borrow(this).unsafe_cast())
}
