...
impl<O: IsA<URIResponse>> URIResponseExt for O {
    fn get_content_length(&self) -> u64 {
        unsafe {
            webkit2_webextension_sys::webkit_uri_response_get_content_length(
    ...
    //#[cfg(any(feature = "v2_6", feature = "dox"))]
    //fn get_http_headers(&self) -> /*Ignored*/Option<soup::MessageHeaders> {
    //    unsafe { TODO: call webkit2_webextension_sys:webkit_uri_response_get_http_headers() }
    //}

    fn get_mime_type(&self) -> Option<GString> {
        unsafe {
            from_glib_none(webkit2_webextension_sys::webkit_uri_response_get_mime_type(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn get_status_code(&self) -> u32 {
        unsafe {
            webkit2_webextension_sys::webkit_uri_response_get_status_code(
                self.as_ref().to_glib_none().0,
            )
        }
    }
    ...
    fn get_suggested_filename(&self) -> Option<GString> {
        unsafe {
            from_glib_none(
                webkit2_webextension_sys::webkit_uri_response_get_suggested_filename(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn get_uri(&self) -> Option<GString> {
        unsafe {
            from_glib_none(webkit2_webextension_sys::webkit_uri_response_get_uri(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn connect_property_content_length_notify<F: Fn(&Self) + 'static>(
        ...
        unsafe extern "C" fn notify_content_length_trampoline<P, F: Fn(&P) + 'static>(
            this: *mut webkit2_webextension_sys::WebKitURIResponse,
