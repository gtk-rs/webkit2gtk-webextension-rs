...
pub trait DOMHTMLBodyElementExt: 'static {
    ...
    fn get_a_link(&self) -> Option<glib::GString>;

    #[cfg_attr(feature = "v2_22", deprecated)]
    #[doc(alias = "webkit_dom_html_body_element_get_background")]
    fn get_background(&self) -> Option<glib::GString>;
    ...
    fn get_link(&self) -> Option<glib::GString>;
    ...
    fn get_v_link(&self) -> Option<glib::GString>;
...
impl<O: IsA<DOMHTMLBodyElement>> DOMHTMLBodyElementExt for O {
    ...
    fn connect_property_a_link_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_a_link_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLBodyElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
    ...
    fn connect_property_background_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_background_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLBodyElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLBodyElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLBodyElement::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_bg_color_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_bg_color_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLBodyElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLBodyElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLBodyElement::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_link_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_link_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLBodyElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLBodyElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLBodyElement::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_text_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_text_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLBodyElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLBodyElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLBodyElement::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_v_link_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_v_link_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLBodyElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLBodyElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLBodyElement::from_glib_borrow(this).unsafe_cast_ref())
