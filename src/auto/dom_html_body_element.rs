...
unsafe extern "C" fn notify_a_link_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLBodyElement, _param_spec: glib_ffi::gpointer, f: glib_ffi::gpointer)
where P: IsA<DOMHTMLBodyElement> {
    let f: &F = &*(f as *const F);
    f(&DOMHTMLBodyElement::from_glib_borrow(this).unsafe_cast())
}

unsafe extern "C" fn notify_background_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLBodyElement, _param_spec: glib_ffi::gpointer, f: glib_ffi::gpointer)
where P: IsA<DOMHTMLBodyElement> {
    let f: &F = &*(f as *const F);
    f(&DOMHTMLBodyElement::from_glib_borrow(this).unsafe_cast())
}

unsafe extern "C" fn notify_bg_color_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLBodyElement, _param_spec: glib_ffi::gpointer, f: glib_ffi::gpointer)
where P: IsA<DOMHTMLBodyElement> {
    let f: &F = &*(f as *const F);
    f(&DOMHTMLBodyElement::from_glib_borrow(this).unsafe_cast())
}

unsafe extern "C" fn notify_link_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLBodyElement, _param_spec: glib_ffi::gpointer, f: glib_ffi::gpointer)
where P: IsA<DOMHTMLBodyElement> {
    let f: &F = &*(f as *const F);
    f(&DOMHTMLBodyElement::from_glib_borrow(this).unsafe_cast())
}

unsafe extern "C" fn notify_text_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLBodyElement, _param_spec: glib_ffi::gpointer, f: glib_ffi::gpointer)
where P: IsA<DOMHTMLBodyElement> {
    let f: &F = &*(f as *const F);
    f(&DOMHTMLBodyElement::from_glib_borrow(this).unsafe_cast())
}

unsafe extern "C" fn notify_v_link_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLBodyElement, _param_spec: glib_ffi::gpointer, f: glib_ffi::gpointer)
where P: IsA<DOMHTMLBodyElement> {
    let f: &F = &*(f as *const F);
    f(&DOMHTMLBodyElement::from_glib_borrow(this).unsafe_cast())
}
