...
impl<O: IsA<DOMHTMLTitleElement>> DOMHTMLTitleElementExt for O {
    fn get_text(&self) -> Option<GString> {
        unsafe {
            from_glib_full(
                webkit2_webextension_sys::webkit_dom_html_title_element_get_text(
    ...
    fn set_text(&self, value: &str) {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_title_element_set_text(
                self.as_ref().to_glib_none().0,
    ...
    fn connect_property_text_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_text_trampoline<P, F: Fn(&P) + 'static>(
            this: *mut webkit2_webextension_sys::WebKitDOMHTMLTitleElement,
