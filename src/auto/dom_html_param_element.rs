...
impl<O: IsA<DOMHTMLParamElement>> DOMHTMLParamElementExt for O {
    fn get_name(&self) -> Option<GString> {
        unsafe {
            from_glib_full(
                webkit2_webextension_sys::webkit_dom_html_param_element_get_name(
    ...
    fn get_type_attr(&self) -> Option<GString> {
        unsafe {
            from_glib_full(
                webkit2_webextension_sys::webkit_dom_html_param_element_get_type_attr(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn get_value(&self) -> Option<GString> {
        unsafe {
            from_glib_full(
                webkit2_webextension_sys::webkit_dom_html_param_element_get_value(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn get_value_type(&self) -> Option<GString> {
        unsafe {
            from_glib_full(
                webkit2_webextension_sys::webkit_dom_html_param_element_get_value_type(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn set_name(&self, value: &str) {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_param_element_set_name(
                self.as_ref().to_glib_none().0,
    ...
    fn set_type_attr(&self, value: &str) {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_param_element_set_type_attr(
                self.as_ref().to_glib_none().0,
                value.to_glib_none().0,
            );
        }
    ...
    fn set_value(&self, value: &str) {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_param_element_set_value(
                self.as_ref().to_glib_none().0,
                value.to_glib_none().0,
            );
        }
    ...
    fn set_value_type(&self, value: &str) {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_param_element_set_value_type(
                self.as_ref().to_glib_none().0,
                value.to_glib_none().0,
            );
        }
    ...
    fn connect_property_name_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_name_trampoline<P, F: Fn(&P) + 'static>(
            this: *mut webkit2_webextension_sys::WebKitDOMHTMLParamElement,
    ...
    fn connect_property_value_type_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_value_type_trampoline<P, F: Fn(&P) + 'static>(
            this: *mut webkit2_webextension_sys::WebKitDOMHTMLParamElement,
            _param_spec: glib_sys::gpointer,
            f: glib_sys::gpointer,
        ) where
        ...
        unsafe {
            ...
            connect_raw(
                self.as_ptr() as *mut _,
                b"notify::value-type\0".as_ptr() as *const _,
                Some(transmute(notify_value_type_trampoline::<Self, F> as usize)),
                Box_::into_raw(f),
            )
        }
    }
