...
glib_wrapper! {
    pub struct DOMHTMLParamElement(Object<ffi::WebKitDOMHTMLParamElement, ffi::WebKitDOMHTMLParamElementClass>): DOMHTMLElement, DOMElement, DOMNode, DOMObject, DOMEventTarget;
