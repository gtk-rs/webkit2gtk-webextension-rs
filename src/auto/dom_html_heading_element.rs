...
impl<O: IsA<DOMHTMLHeadingElement>> DOMHTMLHeadingElementExt for O {
    ...
    fn connect_align_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_align_trampoline<P: IsA<DOMHTMLHeadingElement>, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLHeadingElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
