...
unsafe extern "C" fn notify_autofocus_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLButtonElement, _param_spec: glib_ffi::gpointer, f: glib_ffi::gpointer)
where P: IsA<DOMHTMLButtonElement> {
    let f: &F = &*(f as *const F);
    f(&DOMHTMLButtonElement::from_glib_borrow(this).unsafe_cast())
}

unsafe extern "C" fn notify_disabled_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLButtonElement, _param_spec: glib_ffi::gpointer, f: glib_ffi::gpointer)
where P: IsA<DOMHTMLButtonElement> {
    let f: &F = &*(f as *const F);
    f(&DOMHTMLButtonElement::from_glib_borrow(this).unsafe_cast())
}

unsafe extern "C" fn notify_form_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLButtonElement, _param_spec: glib_ffi::gpointer, f: glib_ffi::gpointer)
where P: IsA<DOMHTMLButtonElement> {
    let f: &F = &*(f as *const F);
    f(&DOMHTMLButtonElement::from_glib_borrow(this).unsafe_cast())
}

unsafe extern "C" fn notify_name_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLButtonElement, _param_spec: glib_ffi::gpointer, f: glib_ffi::gpointer)
where P: IsA<DOMHTMLButtonElement> {
    let f: &F = &*(f as *const F);
    f(&DOMHTMLButtonElement::from_glib_borrow(this).unsafe_cast())
}

unsafe extern "C" fn notify_type_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLButtonElement, _param_spec: glib_ffi::gpointer, f: glib_ffi::gpointer)
where P: IsA<DOMHTMLButtonElement> {
    let f: &F = &*(f as *const F);
    f(&DOMHTMLButtonElement::from_glib_borrow(this).unsafe_cast())
}

unsafe extern "C" fn notify_value_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLButtonElement, _param_spec: glib_ffi::gpointer, f: glib_ffi::gpointer)
where P: IsA<DOMHTMLButtonElement> {
    let f: &F = &*(f as *const F);
    f(&DOMHTMLButtonElement::from_glib_borrow(this).unsafe_cast())
}

unsafe extern "C" fn notify_will_validate_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLButtonElement, _param_spec: glib_ffi::gpointer, f: glib_ffi::gpointer)
where P: IsA<DOMHTMLButtonElement> {
    let f: &F = &*(f as *const F);
    f(&DOMHTMLButtonElement::from_glib_borrow(this).unsafe_cast())
}
