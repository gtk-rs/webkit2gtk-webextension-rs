...
pub trait DOMHTMLTextAreaElementExt: 'static {
    ...
    fn get_area_type(&self) -> Option<glib::GString>;
...
impl<O: IsA<DOMHTMLTextAreaElement>> DOMHTMLTextAreaElementExt for O {
    ...
    fn connect_property_autofocus_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_autofocus_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLTextAreaElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
    ...
    fn connect_property_cols_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_cols_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLTextAreaElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLTextAreaElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLTextAreaElement::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_default_value_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_default_value_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLTextAreaElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLTextAreaElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLTextAreaElement::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_disabled_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_disabled_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLTextAreaElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLTextAreaElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLTextAreaElement::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_form_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_form_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLTextAreaElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLTextAreaElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLTextAreaElement::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_name_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_name_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLTextAreaElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLTextAreaElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLTextAreaElement::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_read_only_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_read_only_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLTextAreaElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLTextAreaElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLTextAreaElement::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_rows_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_rows_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLTextAreaElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLTextAreaElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLTextAreaElement::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_selection_end_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_selection_end_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLTextAreaElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLTextAreaElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLTextAreaElement::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_selection_start_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_selection_start_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLTextAreaElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLTextAreaElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLTextAreaElement::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_type_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_type_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLTextAreaElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLTextAreaElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLTextAreaElement::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_value_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_value_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLTextAreaElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLTextAreaElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLTextAreaElement::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_will_validate_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_will_validate_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLTextAreaElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLTextAreaElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLTextAreaElement::from_glib_borrow(this).unsafe_cast_ref())
