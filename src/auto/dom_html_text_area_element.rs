...
impl<O: IsA<DOMHTMLTextAreaElement>> DOMHTMLTextAreaElementExt for O {
    fn get_area_type(&self) -> Option<GString> {
        unsafe {
            from_glib_full(
                webkit2_webextension_sys::webkit_dom_html_text_area_element_get_area_type(
    ...
    fn get_autofocus(&self) -> bool {
        unsafe {
            from_glib(
                webkit2_webextension_sys::webkit_dom_html_text_area_element_get_autofocus(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn get_cols(&self) -> libc::c_long {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_text_area_element_get_cols(
                self.as_ref().to_glib_none().0,
            )
        }
    }
    ...
    fn get_default_value(&self) -> Option<GString> {
        unsafe {
            from_glib_full(
                webkit2_webextension_sys::webkit_dom_html_text_area_element_get_default_value(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn get_disabled(&self) -> bool {
        unsafe {
            from_glib(
                webkit2_webextension_sys::webkit_dom_html_text_area_element_get_disabled(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn get_form(&self) -> Option<DOMHTMLFormElement> {
        unsafe {
            from_glib_none(
                webkit2_webextension_sys::webkit_dom_html_text_area_element_get_form(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn get_name(&self) -> Option<GString> {
        unsafe {
            from_glib_full(
                webkit2_webextension_sys::webkit_dom_html_text_area_element_get_name(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn get_read_only(&self) -> bool {
        unsafe {
            from_glib(
                webkit2_webextension_sys::webkit_dom_html_text_area_element_get_read_only(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn get_rows(&self) -> libc::c_long {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_text_area_element_get_rows(
                self.as_ref().to_glib_none().0,
            )
        }
    }
    ...
    fn get_selection_end(&self) -> libc::c_long {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_text_area_element_get_selection_end(
                self.as_ref().to_glib_none().0,
            )
        }
    }
    ...
    fn get_selection_start(&self) -> libc::c_long {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_text_area_element_get_selection_start(
                self.as_ref().to_glib_none().0,
            )
        }
    }
    ...
    fn get_value(&self) -> Option<GString> {
        unsafe {
            from_glib_full(
                webkit2_webextension_sys::webkit_dom_html_text_area_element_get_value(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn get_will_validate(&self) -> bool {
        unsafe {
            from_glib(
                webkit2_webextension_sys::webkit_dom_html_text_area_element_get_will_validate(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn is_edited(&self) -> bool {
        unsafe {
            from_glib(
                webkit2_webextension_sys::webkit_dom_html_text_area_element_is_edited(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn select(&self) {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_text_area_element_select(
                self.as_ref().to_glib_none().0,
            );
        }
    }
    ...
    fn set_autofocus(&self, value: bool) {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_text_area_element_set_autofocus(
                self.as_ref().to_glib_none().0,
                value.to_glib(),
            );
        }
    ...
    fn set_cols(&self, value: libc::c_long) {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_text_area_element_set_cols(
                self.as_ref().to_glib_none().0,
                value,
            );
        }
    ...
    fn set_default_value(&self, value: &str) {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_text_area_element_set_default_value(
                self.as_ref().to_glib_none().0,
    ...
    fn set_disabled(&self, value: bool) {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_text_area_element_set_disabled(
                self.as_ref().to_glib_none().0,
                value.to_glib(),
            );
        }
    ...
    fn set_name(&self, value: &str) {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_text_area_element_set_name(
                self.as_ref().to_glib_none().0,
                value.to_glib_none().0,
            );
        }
    ...
    fn set_read_only(&self, value: bool) {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_text_area_element_set_read_only(
                self.as_ref().to_glib_none().0,
                value.to_glib(),
            );
        }
    ...
    fn set_rows(&self, value: libc::c_long) {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_text_area_element_set_rows(
                self.as_ref().to_glib_none().0,
                value,
            );
        }
    ...
    fn set_selection_end(&self, value: libc::c_long) {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_text_area_element_set_selection_end(
                self.as_ref().to_glib_none().0,
                value,
            );
        }
    ...
    fn set_selection_range(&self, start: libc::c_long, end: libc::c_long, direction: &str) {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_text_area_element_set_selection_range(
                self.as_ref().to_glib_none().0,
                start,
                end,
    ...
    fn set_selection_start(&self, value: libc::c_long) {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_text_area_element_set_selection_start(
                self.as_ref().to_glib_none().0,
                value,
            );
        }
    ...
    fn set_value(&self, value: &str) {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_text_area_element_set_value(
                self.as_ref().to_glib_none().0,
                value.to_glib_none().0,
            );
        }
    ...
    fn connect_property_autofocus_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_autofocus_trampoline<P, F: Fn(&P) + 'static>(
            this: *mut webkit2_webextension_sys::WebKitDOMHTMLTextAreaElement,
    ...
    fn connect_property_selection_end_notify<F: Fn(&Self) + 'static>(
        ...
        unsafe {
            ...
            connect_raw(
                ...
                Some(transmute(
                    notify_selection_end_trampoline::<Self, F> as usize,
                )),
                Box_::into_raw(f),
            )
        }
    ...
    fn connect_property_selection_start_notify<F: Fn(&Self) + 'static>(
        ...
        unsafe {
            ...
            connect_raw(
                ...
                Some(transmute(
                    notify_selection_start_trampoline::<Self, F> as usize,
                )),
                Box_::into_raw(f),
            )
        }
