...
impl<O: IsA<WebPage>> WebPageExt for O {
    ...
    #[cfg_attr(feature = "dox", doc(cfg(feature = "v2_12")))]
    fn connect_console_message_sent<F: Fn(&Self, &ConsoleMessage) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn console_message_sent_trampoline<P, F: Fn(&P, &ConsoleMessage) + 'static>(this: *mut ffi::WebKitWebPage, console_message: *mut ffi::WebKitConsoleMessage, f: glib::ffi::gpointer)
            where P: IsA<WebPage>
        {
    ...
    #[cfg_attr(feature = "dox", doc(cfg(feature = "v2_8")))]
    fn connect_context_menu<F: Fn(&Self, &ContextMenu, &WebHitTestResult) -> bool + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn context_menu_trampoline<P, F: Fn(&P, &ContextMenu, &WebHitTestResult) -> bool + 'static>(this: *mut ffi::WebKitWebPage, context_menu: *mut ffi::WebKitContextMenu, hit_test_result: *mut ffi::WebKitWebHitTestResult, f: glib::ffi::gpointer) -> glib::ffi::gboolean
            where P: IsA<WebPage>
        {
            let f: &F = &*(f as *const F);
            f(&WebPage::from_glib_borrow(this).unsafe_cast_ref(), &from_glib_borrow(context_menu), &from_glib_borrow(hit_test_result)).to_glib()
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
    ...
    fn connect_document_loaded<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn document_loaded_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitWebPage, f: glib::ffi::gpointer)
            where P: IsA<WebPage>
        {
            let f: &F = &*(f as *const F);
    ...
    fn connect_send_request<F: Fn(&Self, &URIRequest, Option<&URIResponse>) -> bool + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn send_request_trampoline<P, F: Fn(&P, &URIRequest, Option<&URIResponse>) -> bool + 'static>(this: *mut ffi::WebKitWebPage, request: *mut ffi::WebKitURIRequest, redirected_response: *mut ffi::WebKitURIResponse, f: glib::ffi::gpointer) -> glib::ffi::gboolean
            where P: IsA<WebPage>
        {
            let f: &F = &*(f as *const F);
            f(&WebPage::from_glib_borrow(this).unsafe_cast_ref(), &from_glib_borrow(request), Option::<URIResponse>::from_glib_borrow(redirected_response).as_ref().as_ref()).to_glib()
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
    ...
    fn connect_property_uri_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_uri_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitWebPage, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<WebPage>
        {
            let f: &F = &*(f as *const F);
            f(&WebPage::from_glib_borrow(this).unsafe_cast_ref())
