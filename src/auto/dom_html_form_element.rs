...
pub trait DOMHTMLFormElementExt: 'static {
    ...
    fn get_accept_charset(&self) -> Option<glib::GString>;
    ...
    fn get_encoding(&self) -> Option<glib::GString>;

    #[cfg_attr(feature = "v2_22", deprecated)]
    #[doc(alias = "webkit_dom_html_form_element_get_enctype")]
    fn get_enctype(&self) -> Option<glib::GString>;
    ...
    fn get_method(&self) -> Option<glib::GString>;
...
impl<O: IsA<DOMHTMLFormElement>> DOMHTMLFormElementExt for O {
    ...
    fn connect_property_accept_charset_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_accept_charset_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLFormElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
    ...
    fn connect_property_action_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_action_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLFormElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLFormElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLFormElement::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_elements_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_elements_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLFormElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLFormElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLFormElement::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_encoding_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_encoding_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLFormElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLFormElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLFormElement::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_enctype_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_enctype_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLFormElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLFormElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLFormElement::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_length_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_length_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLFormElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLFormElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLFormElement::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_method_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_method_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLFormElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLFormElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLFormElement::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_name_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_name_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLFormElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLFormElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLFormElement::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_target_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_target_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLFormElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLFormElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLFormElement::from_glib_borrow(this).unsafe_cast_ref())
