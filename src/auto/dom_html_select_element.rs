...
pub trait DOMHTMLSelectElementExt: 'static {
    ...
    fn get_select_type(&self) -> Option<glib::GString>;
...
impl<O: IsA<DOMHTMLSelectElement>> DOMHTMLSelectElementExt for O {
    ...
    fn connect_property_autofocus_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_autofocus_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLSelectElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
    ...
    fn connect_property_disabled_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_disabled_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLSelectElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLSelectElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLSelectElement::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_form_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_form_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLSelectElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLSelectElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLSelectElement::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_length_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_length_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLSelectElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLSelectElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLSelectElement::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_multiple_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_multiple_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLSelectElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLSelectElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLSelectElement::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_name_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_name_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLSelectElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLSelectElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLSelectElement::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_options_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_options_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLSelectElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLSelectElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLSelectElement::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_selected_index_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_selected_index_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLSelectElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLSelectElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLSelectElement::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_size_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_size_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLSelectElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLSelectElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLSelectElement::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_type_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_type_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLSelectElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLSelectElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLSelectElement::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_value_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_value_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLSelectElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLSelectElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLSelectElement::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_will_validate_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_will_validate_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLSelectElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLSelectElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLSelectElement::from_glib_borrow(this).unsafe_cast_ref())
