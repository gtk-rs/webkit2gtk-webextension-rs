...
impl<O: IsA<DOMCSSRule>> DOMCSSRuleExt for O {
    ...
    fn connect_property_css_text_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_css_text_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMCSSRule, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
    ...
    fn connect_property_parent_rule_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_parent_rule_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMCSSRule, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMCSSRule>
        {
            let f: &F = &*(f as *const F);
            f(&DOMCSSRule::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_parent_style_sheet_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_parent_style_sheet_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMCSSRule, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMCSSRule>
        {
            let f: &F = &*(f as *const F);
            f(&DOMCSSRule::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_type_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_type_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMCSSRule, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMCSSRule>
        {
            let f: &F = &*(f as *const F);
            f(&DOMCSSRule::from_glib_borrow(this).unsafe_cast_ref())
