...
glib_wrapper! {
    pub struct DOMCSSRule(Object<ffi::WebKitDOMCSSRule>);
...
impl DOMCSSRule {
    ...
    //pub fn get_parent_style_sheet(&self) -> /*Ignored*/Option<DOMCSSStyleSheet> {
    //    unsafe { TODO: call ffi::webkit_dom_css_rule_get_parent_style_sheet() }
    //}
