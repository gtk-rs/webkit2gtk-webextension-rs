...
unsafe extern "C" fn notify_href_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLBaseElement, _param_spec: glib_ffi::gpointer, f: glib_ffi::gpointer)
where P: IsA<DOMHTMLBaseElement> {
    let f: &F = &*(f as *const F);
    f(&DOMHTMLBaseElement::from_glib_borrow(this).unsafe_cast())
}

unsafe extern "C" fn notify_target_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLBaseElement, _param_spec: glib_ffi::gpointer, f: glib_ffi::gpointer)
where P: IsA<DOMHTMLBaseElement> {
    let f: &F = &*(f as *const F);
    f(&DOMHTMLBaseElement::from_glib_borrow(this).unsafe_cast())
}
