...
impl<O: IsA<DOMHTMLTableSectionElement>> DOMHTMLTableSectionElementExt for O {
    fn delete_row(&self, index: libc::c_long) -> Result<(), glib::Error> {
        unsafe {
            ...
            let _ = webkit2_webextension_sys::webkit_dom_html_table_section_element_delete_row(
    ...
    fn get_align(&self) -> Option<GString> {
        unsafe {
            from_glib_full(
                webkit2_webextension_sys::webkit_dom_html_table_section_element_get_align(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn get_ch(&self) -> Option<GString> {
        unsafe {
            from_glib_full(
                webkit2_webextension_sys::webkit_dom_html_table_section_element_get_ch(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn get_ch_off(&self) -> Option<GString> {
        unsafe {
            from_glib_full(
                webkit2_webextension_sys::webkit_dom_html_table_section_element_get_ch_off(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn get_rows(&self) -> Option<DOMHTMLCollection> {
        unsafe {
            from_glib_full(
                webkit2_webextension_sys::webkit_dom_html_table_section_element_get_rows(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn get_v_align(&self) -> Option<GString> {
        unsafe {
            from_glib_full(
                webkit2_webextension_sys::webkit_dom_html_table_section_element_get_v_align(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn insert_row(&self, index: libc::c_long) -> Result<DOMHTMLElement, glib::Error> {
        unsafe {
            let mut error = ptr::null_mut();
            let ret = webkit2_webextension_sys::webkit_dom_html_table_section_element_insert_row(
                self.as_ref().to_glib_none().0,
                index,
                &mut error,
            );
    ...
    fn set_align(&self, value: &str) {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_table_section_element_set_align(
                self.as_ref().to_glib_none().0,
    ...
    fn set_ch(&self, value: &str) {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_table_section_element_set_ch(
                self.as_ref().to_glib_none().0,
                value.to_glib_none().0,
            );
        }
    ...
    fn set_ch_off(&self, value: &str) {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_table_section_element_set_ch_off(
                self.as_ref().to_glib_none().0,
                value.to_glib_none().0,
            );
        }
    ...
    fn set_v_align(&self, value: &str) {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_table_section_element_set_v_align(
                self.as_ref().to_glib_none().0,
                value.to_glib_none().0,
            );
        }
    ...
    fn connect_property_align_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_align_trampoline<P, F: Fn(&P) + 'static>(
            this: *mut webkit2_webextension_sys::WebKitDOMHTMLTableSectionElement,
