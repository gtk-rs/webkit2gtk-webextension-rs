...
glib::wrapper! {
    #[doc(alias = "WebKitDOMHTMLTableSectionElement")]
...
impl<O: IsA<DOMHTMLTableSectionElement>> DOMHTMLTableSectionElementExt for O {
    ...
    fn connect_align_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_align_trampoline<P: IsA<DOMHTMLTableSectionElement>, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLTableSectionElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
    ...
    fn connect_ch_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_ch_trampoline<P: IsA<DOMHTMLTableSectionElement>, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLTableSectionElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(DOMHTMLTableSectionElement::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_ch_off_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_ch_off_trampoline<P: IsA<DOMHTMLTableSectionElement>, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLTableSectionElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(DOMHTMLTableSectionElement::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_rows_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_rows_trampoline<P: IsA<DOMHTMLTableSectionElement>, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLTableSectionElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(DOMHTMLTableSectionElement::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_v_align_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_v_align_trampoline<P: IsA<DOMHTMLTableSectionElement>, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLTableSectionElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(DOMHTMLTableSectionElement::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
