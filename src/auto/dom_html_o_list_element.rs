...
impl<O: IsA<DOMHTMLOListElement>> DOMHTMLOListElementExt for O {
    ...
    fn connect_property_compact_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_compact_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLOListElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
    ...
    fn connect_property_start_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_start_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLOListElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLOListElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLOListElement::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_type_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_type_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLOListElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLOListElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLOListElement::from_glib_borrow(this).unsafe_cast_ref())
