...
impl<O: IsA<DOMHTMLOListElement>> DOMHTMLOListElementExt for O {
    fn get_compact(&self) -> bool {
        unsafe {
            from_glib(
                webkit2_webextension_sys::webkit_dom_html_o_list_element_get_compact(
    ...
    fn get_start(&self) -> libc::c_long {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_o_list_element_get_start(
                self.as_ref().to_glib_none().0,
            )
        }
    }
    ...
    fn get_type_attr(&self) -> Option<GString> {
        unsafe {
            from_glib_full(
                webkit2_webextension_sys::webkit_dom_html_o_list_element_get_type_attr(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn set_compact(&self, value: bool) {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_o_list_element_set_compact(
                self.as_ref().to_glib_none().0,
                value.to_glib(),
            );
        }
    ...
    fn set_start(&self, value: libc::c_long) {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_o_list_element_set_start(
                self.as_ref().to_glib_none().0,
                value,
            );
        }
    ...
    fn set_type_attr(&self, value: &str) {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_o_list_element_set_type_attr(
                self.as_ref().to_glib_none().0,
    ...
    fn connect_property_compact_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_compact_trampoline<P, F: Fn(&P) + 'static>(
            this: *mut webkit2_webextension_sys::WebKitDOMHTMLOListElement,
