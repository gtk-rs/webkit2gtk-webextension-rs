...
pub trait FrameExt: 'static {
    ...
    //fn javascript_context_for_script_world<P: IsA<ScriptWorld>>(&self, world: &P) -> /*Ignored*/Option<java_script_core::GlobalContextRef>;
    ...
    //fn js_context_for_script_world<P: IsA<ScriptWorld>>(&self, world: &P) -> /*Ignored*/Option<java_script_core::Context>;

    //#[cfg(any(feature = "v2_22", feature = "dox"))]
    //#[cfg_attr(feature = "dox", doc(cfg(feature = "v2_22")))]
    //#[doc(alias = "webkit_frame_get_js_value_for_dom_object")]
    //fn js_value_for_dom_object<P: IsA<DOMObject>>(&self, dom_object: &P) -> /*Ignored*/Option<java_script_core::Value>;

    //#[cfg(any(feature = "v2_22", feature = "dox"))]
    //#[cfg_attr(feature = "dox", doc(cfg(feature = "v2_22")))]
    //#[doc(alias = "webkit_frame_get_js_value_for_dom_object_in_script_world")]
    //fn js_value_for_dom_object_in_script_world<P: IsA<DOMObject>, Q: IsA<ScriptWorld>>(&self, dom_object: &P, world: &Q) -> /*Ignored*/Option<java_script_core::Value>;
