...
pub trait DOMKeyboardEventExt: 'static {
    ...
    fn connect_property_key_location_notify<F: Fn(&Self) + 'static>(&self, f: F)
        -> SignalHandlerId;
...
impl<O: IsA<DOMKeyboardEvent>> DOMKeyboardEventExt for O {
    fn get_alt_graph_key(&self) -> bool {
        unsafe {
            from_glib(
                webkit2_webextension_sys::webkit_dom_keyboard_event_get_alt_graph_key(
    ...
    fn get_alt_key(&self) -> bool {
        unsafe {
            from_glib(
                webkit2_webextension_sys::webkit_dom_keyboard_event_get_alt_key(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn get_ctrl_key(&self) -> bool {
        unsafe {
            from_glib(
                webkit2_webextension_sys::webkit_dom_keyboard_event_get_ctrl_key(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn get_key_identifier(&self) -> Option<GString> {
        unsafe {
            from_glib_full(
                webkit2_webextension_sys::webkit_dom_keyboard_event_get_key_identifier(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn get_key_location(&self) -> libc::c_ulong {
        unsafe {
            webkit2_webextension_sys::webkit_dom_keyboard_event_get_key_location(
                self.as_ref().to_glib_none().0,
            )
        }
    }
    ...
    fn get_meta_key(&self) -> bool {
        unsafe {
            from_glib(
                webkit2_webextension_sys::webkit_dom_keyboard_event_get_meta_key(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn get_modifier_state(&self, keyIdentifierArg: &str) -> bool {
        unsafe {
            from_glib(
                webkit2_webextension_sys::webkit_dom_keyboard_event_get_modifier_state(
                    self.as_ref().to_glib_none().0,
    ...
    fn get_shift_key(&self) -> bool {
        unsafe {
            from_glib(
                webkit2_webextension_sys::webkit_dom_keyboard_event_get_shift_key(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn connect_property_alt_graph_key_notify<F: Fn(&Self) + 'static>(
        ...
        unsafe extern "C" fn notify_alt_graph_key_trampoline<P, F: Fn(&P) + 'static>(
            this: *mut webkit2_webextension_sys::WebKitDOMKeyboardEvent,
    ...
    fn connect_property_key_identifier_notify<F: Fn(&Self) + 'static>(
        ...
        unsafe extern "C" fn notify_key_identifier_trampoline<P, F: Fn(&P) + 'static>(
            this: *mut webkit2_webextension_sys::WebKitDOMKeyboardEvent,
            _param_spec: glib_sys::gpointer,
            f: glib_sys::gpointer,
        ) where
    ...
    fn connect_property_key_location_notify<F: Fn(&Self) + 'static>(
        ...
        unsafe extern "C" fn notify_key_location_trampoline<P, F: Fn(&P) + 'static>(
            this: *mut webkit2_webextension_sys::WebKitDOMKeyboardEvent,
            _param_spec: glib_sys::gpointer,
            f: glib_sys::gpointer,
        ) where
