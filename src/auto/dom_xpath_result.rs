...
pub trait DOMXPathResultExt: 'static {
    ...
    fn get_string_value(&self) -> Result<glib::GString, glib::Error>;
...
impl<O: IsA<DOMXPathResult>> DOMXPathResultExt for O {
    ...
    fn connect_property_boolean_value_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_boolean_value_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMXPathResult, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
    ...
    fn connect_property_invalid_iterator_state_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_invalid_iterator_state_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMXPathResult, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMXPathResult>
        {
            let f: &F = &*(f as *const F);
            f(&DOMXPathResult::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_number_value_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_number_value_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMXPathResult, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMXPathResult>
        {
            let f: &F = &*(f as *const F);
            f(&DOMXPathResult::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_result_type_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_result_type_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMXPathResult, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMXPathResult>
        {
            let f: &F = &*(f as *const F);
            f(&DOMXPathResult::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_single_node_value_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_single_node_value_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMXPathResult, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMXPathResult>
        {
            let f: &F = &*(f as *const F);
            f(&DOMXPathResult::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_snapshot_length_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_snapshot_length_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMXPathResult, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMXPathResult>
        {
            let f: &F = &*(f as *const F);
            f(&DOMXPathResult::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_string_value_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_string_value_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMXPathResult, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMXPathResult>
        {
            let f: &F = &*(f as *const F);
            f(&DOMXPathResult::from_glib_borrow(this).unsafe_cast_ref())
