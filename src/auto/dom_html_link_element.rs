...
pub trait DOMHTMLLinkElementExt: 'static {
    ...
    fn get_media(&self) -> Option<glib::GString>;
...
impl<O: IsA<DOMHTMLLinkElement>> DOMHTMLLinkElementExt for O {
    ...
    fn connect_property_charset_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_charset_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLLinkElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
    ...
    fn connect_property_disabled_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_disabled_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLLinkElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLLinkElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLLinkElement::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_href_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_href_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLLinkElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLLinkElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLLinkElement::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_hreflang_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_hreflang_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLLinkElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLLinkElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLLinkElement::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_media_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_media_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLLinkElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLLinkElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLLinkElement::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_rel_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_rel_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLLinkElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLLinkElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLLinkElement::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_rev_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_rev_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLLinkElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLLinkElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLLinkElement::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_sheet_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_sheet_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLLinkElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLLinkElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLLinkElement::from_glib_borrow(this).unsafe_cast_ref())
    ...
    #[cfg_attr(feature = "dox", doc(cfg(feature = "v2_16")))]
    fn connect_property_sizes_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_sizes_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLLinkElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLLinkElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLLinkElement::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_target_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_target_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLLinkElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLLinkElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLLinkElement::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_type_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_type_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLLinkElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLLinkElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLLinkElement::from_glib_borrow(this).unsafe_cast_ref())
