...
impl<O: IsA<DOMMediaList>> DOMMediaListExt for O {
    fn append_medium(&self, newMedium: &str) -> Result<(), glib::Error> {
        unsafe {
            ...
            let _ = webkit2_webextension_sys::webkit_dom_media_list_append_medium(
    ...
    fn delete_medium(&self, oldMedium: &str) -> Result<(), glib::Error> {
        unsafe {
            let mut error = ptr::null_mut();
            let _ = webkit2_webextension_sys::webkit_dom_media_list_delete_medium(
                self.as_ref().to_glib_none().0,
    ...
    fn get_length(&self) -> libc::c_ulong {
        unsafe {
            webkit2_webextension_sys::webkit_dom_media_list_get_length(
                self.as_ref().to_glib_none().0,
            )
        }
    }
    ...
    fn get_media_text(&self) -> Option<GString> {
        unsafe {
            from_glib_full(
                webkit2_webextension_sys::webkit_dom_media_list_get_media_text(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn item(&self, index: libc::c_ulong) -> Option<GString> {
        unsafe {
            from_glib_full(webkit2_webextension_sys::webkit_dom_media_list_item(
                self.as_ref().to_glib_none().0,
                index,
            ))
        }
    ...
    fn set_media_text(&self, value: &str) -> Result<(), glib::Error> {
        unsafe {
            let mut error = ptr::null_mut();
            let _ = webkit2_webextension_sys::webkit_dom_media_list_set_media_text(
                self.as_ref().to_glib_none().0,
    ...
    fn connect_property_length_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_length_trampoline<P, F: Fn(&P) + 'static>(
            this: *mut webkit2_webextension_sys::WebKitDOMMediaList,
    ...
    fn connect_property_media_text_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            ...
            connect_raw(
                ...
                Some(transmute(notify_media_text_trampoline::<Self, F> as usize)),
                Box_::into_raw(f),
            )
        }
    }
