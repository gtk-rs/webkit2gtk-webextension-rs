...
pub trait DOMMediaListExt: 'static {
    ...
    fn get_media_text(&self) -> Option<glib::GString>;
...
impl<O: IsA<DOMMediaList>> DOMMediaListExt for O {
    ...
    fn connect_property_length_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_length_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMMediaList, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
    ...
    fn connect_property_media_text_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_media_text_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMMediaList, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMMediaList>
        {
            let f: &F = &*(f as *const F);
            f(&DOMMediaList::from_glib_borrow(this).unsafe_cast_ref())
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::media-text\0".as_ptr() as *const _,
                Some(transmute::<_, unsafe extern "C" fn()>(notify_media_text_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
}
