...
impl<O: IsA<DOMHTMLDocument>> DOMHTMLDocumentExt for O {
    fn capture_events(&self) {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_document_capture_events(
    ...
    fn clear(&self) {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_document_clear(
                self.as_ref().to_glib_none().0,
            );
        }
    }
    ...
    fn close(&self) {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_document_close(
                self.as_ref().to_glib_none().0,
            );
        }
    }
    ...
    fn get_alink_color(&self) -> Option<GString> {
        unsafe {
            from_glib_full(
                webkit2_webextension_sys::webkit_dom_html_document_get_alink_color(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn get_bg_color(&self) -> Option<GString> {
        unsafe {
            from_glib_full(
                webkit2_webextension_sys::webkit_dom_html_document_get_bg_color(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn get_compat_mode(&self) -> Option<GString> {
        unsafe {
            from_glib_full(
                webkit2_webextension_sys::webkit_dom_html_document_get_compat_mode(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn get_design_mode(&self) -> Option<GString> {
        unsafe {
            from_glib_full(
                webkit2_webextension_sys::webkit_dom_html_document_get_design_mode(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn get_dir(&self) -> Option<GString> {
        unsafe {
            from_glib_full(webkit2_webextension_sys::webkit_dom_html_document_get_dir(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn get_embeds(&self) -> Option<DOMHTMLCollection> {
        unsafe {
            from_glib_full(
                webkit2_webextension_sys::webkit_dom_html_document_get_embeds(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn get_fg_color(&self) -> Option<GString> {
        unsafe {
            from_glib_full(
                webkit2_webextension_sys::webkit_dom_html_document_get_fg_color(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn get_height(&self) -> libc::c_long {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_document_get_height(
                self.as_ref().to_glib_none().0,
            )
        }
    }
    ...
    fn get_link_color(&self) -> Option<GString> {
        unsafe {
            from_glib_full(
                webkit2_webextension_sys::webkit_dom_html_document_get_link_color(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn get_plugins(&self) -> Option<DOMHTMLCollection> {
        unsafe {
            from_glib_full(
                webkit2_webextension_sys::webkit_dom_html_document_get_plugins(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn get_scripts(&self) -> Option<DOMHTMLCollection> {
        unsafe {
            from_glib_full(
                webkit2_webextension_sys::webkit_dom_html_document_get_scripts(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn get_vlink_color(&self) -> Option<GString> {
        unsafe {
            from_glib_full(
                webkit2_webextension_sys::webkit_dom_html_document_get_vlink_color(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn get_width(&self) -> libc::c_long {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_document_get_width(
                self.as_ref().to_glib_none().0,
            )
        }
    }
    ...
    fn release_events(&self) {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_document_release_events(
                self.as_ref().to_glib_none().0,
            );
        }
    }
    ...
    fn set_alink_color(&self, value: &str) {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_document_set_alink_color(
                self.as_ref().to_glib_none().0,
    ...
    fn set_bg_color(&self, value: &str) {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_document_set_bg_color(
                self.as_ref().to_glib_none().0,
                value.to_glib_none().0,
            );
        }
    ...
    fn set_design_mode(&self, value: &str) {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_document_set_design_mode(
                self.as_ref().to_glib_none().0,
                value.to_glib_none().0,
            );
        }
    ...
    fn set_dir(&self, value: &str) {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_document_set_dir(
                self.as_ref().to_glib_none().0,
                value.to_glib_none().0,
            );
        }
    ...
    fn set_fg_color(&self, value: &str) {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_document_set_fg_color(
                self.as_ref().to_glib_none().0,
                value.to_glib_none().0,
            );
        }
    ...
    fn set_link_color(&self, value: &str) {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_document_set_link_color(
                self.as_ref().to_glib_none().0,
                value.to_glib_none().0,
            );
        }
    ...
    fn set_vlink_color(&self, value: &str) {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_document_set_vlink_color(
                self.as_ref().to_glib_none().0,
                value.to_glib_none().0,
            );
        }
    ...
    fn connect_property_alink_color_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_alink_color_trampoline<P, F: Fn(&P) + 'static>(
            this: *mut webkit2_webextension_sys::WebKitDOMHTMLDocument,
        ...
        unsafe {
            ...
            connect_raw(
                ...
                Some(transmute(notify_alink_color_trampoline::<Self, F> as usize)),
                Box_::into_raw(f),
            )
        }
    }
    ...
    fn connect_property_fg_color_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            ...
            connect_raw(
                ...
                Some(transmute(notify_fg_color_trampoline::<Self, F> as usize)),
                Box_::into_raw(f),
            )
        }
    }
    ...
    fn connect_property_link_color_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            ...
            connect_raw(
                ...
                Some(transmute(notify_link_color_trampoline::<Self, F> as usize)),
                Box_::into_raw(f),
            )
        }
    }
    ...
    fn connect_property_vlink_color_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            ...
            connect_raw(
                ...
                Some(transmute(notify_vlink_color_trampoline::<Self, F> as usize)),
                Box_::into_raw(f),
            )
        }
    }
