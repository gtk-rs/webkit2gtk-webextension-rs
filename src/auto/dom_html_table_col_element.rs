...
impl<O: IsA<DOMHTMLTableColElement>> DOMHTMLTableColElementExt for O {
    fn get_align(&self) -> Option<GString> {
        unsafe {
            from_glib_full(
                webkit2_webextension_sys::webkit_dom_html_table_col_element_get_align(
    ...
    fn get_ch(&self) -> Option<GString> {
        unsafe {
            from_glib_full(
                webkit2_webextension_sys::webkit_dom_html_table_col_element_get_ch(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn get_ch_off(&self) -> Option<GString> {
        unsafe {
            from_glib_full(
                webkit2_webextension_sys::webkit_dom_html_table_col_element_get_ch_off(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn get_span(&self) -> libc::c_long {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_table_col_element_get_span(
                self.as_ref().to_glib_none().0,
            )
        }
    }
    ...
    fn get_v_align(&self) -> Option<GString> {
        unsafe {
            from_glib_full(
                webkit2_webextension_sys::webkit_dom_html_table_col_element_get_v_align(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn get_width(&self) -> Option<GString> {
        unsafe {
            from_glib_full(
                webkit2_webextension_sys::webkit_dom_html_table_col_element_get_width(
                    self.as_ref().to_glib_none().0,
                ),
            )
        }
    ...
    fn set_align(&self, value: &str) {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_table_col_element_set_align(
                self.as_ref().to_glib_none().0,
    ...
    fn set_ch(&self, value: &str) {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_table_col_element_set_ch(
                self.as_ref().to_glib_none().0,
                value.to_glib_none().0,
            );
        }
    ...
    fn set_ch_off(&self, value: &str) {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_table_col_element_set_ch_off(
                self.as_ref().to_glib_none().0,
                value.to_glib_none().0,
            );
        }
    ...
    fn set_span(&self, value: libc::c_long) {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_table_col_element_set_span(
                self.as_ref().to_glib_none().0,
                value,
            );
        }
    ...
    fn set_v_align(&self, value: &str) {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_table_col_element_set_v_align(
                self.as_ref().to_glib_none().0,
                value.to_glib_none().0,
            );
        }
    ...
    fn set_width(&self, value: &str) {
        unsafe {
            webkit2_webextension_sys::webkit_dom_html_table_col_element_set_width(
                self.as_ref().to_glib_none().0,
                value.to_glib_none().0,
            );
        }
    ...
    fn connect_property_align_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_align_trampoline<P, F: Fn(&P) + 'static>(
            this: *mut webkit2_webextension_sys::WebKitDOMHTMLTableColElement,
    ...
    fn connect_property_span_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_span_trampoline<P, F: Fn(&P) + 'static>(
            this: *mut webkit2_webextension_sys::WebKitDOMHTMLTableColElement,
            _param_spec: glib_sys::gpointer,
            f: glib_sys::gpointer,
        ) where
        ...
        unsafe {
            ...
            connect_raw(
                ...
                Some(transmute(notify_span_trampoline::<Self, F> as usize)),
                Box_::into_raw(f),
            )
        }
    }
