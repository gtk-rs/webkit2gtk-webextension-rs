...
pub trait DOMHTMLModElementExt: 'static {
    ...
    fn get_date_time(&self) -> Option<glib::GString>;
...
impl<O: IsA<DOMHTMLModElement>> DOMHTMLModElementExt for O {
    ...
    fn connect_property_cite_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_cite_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLModElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
    ...
    fn connect_property_date_time_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_date_time_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WebKitDOMHTMLModElement, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<DOMHTMLModElement>
        {
            let f: &F = &*(f as *const F);
            f(&DOMHTMLModElement::from_glib_borrow(this).unsafe_cast_ref())
